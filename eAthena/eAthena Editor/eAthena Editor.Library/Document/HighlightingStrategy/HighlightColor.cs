...
namespace GodLesZ.eAthenaEditor.Library.Document {
	...
	public class HighlightColor {
		...
		public HighlightColor(XmlElement el) {
			Debug.Assert(el != null, "Document.SyntaxColor(XmlElement el) : el == null");
		...
		public HighlightColor(XmlElement el, HighlightColor defaultColor) {
			Debug.Assert(el != null, "GodLesZ.eAthenaEditor.Library.Document.SyntaxColor(XmlElement el) : el == null");
			if (el.Attributes["bold"] != null) {
				bold = Boolean.Parse(el.Attributes["bold"].InnerText);
			} else {
