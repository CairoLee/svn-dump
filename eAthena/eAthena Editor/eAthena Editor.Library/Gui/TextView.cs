...
namespace GodLesZ.eAthenaEditor.Library {
	...
	public class TextView : AbstractMargin, IDisposable {
		...
		void DrawBracketHighlight(Graphics g, Rectangle rect) {
			HighlightColor bracketColor = textArea.Document.HighlightingStrategy.GetColorFor("SelectionBracket");

			//g.FillRectangle(BrushRegistry.GetBrush(Color.FromArgb(50, 0, 0, 255)), rect);
			//g.DrawRectangle(Pens.Blue, rect);
			g.FillRectangle(BrushRegistry.GetBrush(Color.FromArgb(50, bracketColor.BackgroundColor)), rect);
		}
