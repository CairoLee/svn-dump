...
namespace GodLesZ.eAthenaEditor.Library {
	...
	/// </summary>
	[ToolboxBitmap("GodLesZ.eAthenaEditor.Library.Resources.TextEditorControl.bmp")]
	[ToolboxItem(true)]
	public class TextEditorControl : TextEditorControlBase {
		protected Panel textAreaPanel = new Panel();
		protected TextAreaControl primaryTextArea;
		protected Splitter textAreaSplitter = null;
		protected TextAreaControl secondaryTextArea = null;
		protected TextAreaControl activeTextAreaControl;
		...
		protected void CommitUpdateRequested(object sender, EventArgs e) {
			if (IsInUpdate) {
				return;
			}
