...
namespace System.Windows.Forms {
	...
	internal class frmInput : Form {
		...
		public frmInput(string prompt, string title) :
			this(prompt, title, int.MinValue, int.MinValue) {
		}

		public frmInput(string prompt, string title, int xPos, int yPos) {
	...
	public static class InputBox {
		static public string Show(string Prompt) { return Show(Prompt, null, null, int.MinValue, int.MinValue, false); }
		static public string Show(string Prompt, string Title, string Default) { return Show(Prompt, Title, Default, int.MinValue, int.MinValue, false); }
		...
		static public string ShowPasswordBox(string Prompt, string Title) { return Show(Prompt, Title, "", int.MinValue, int.MinValue, true); }
	}
}
