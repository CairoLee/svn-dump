...
extern struct Script_Config {
	...
	const char *changeregion_event_name;
	const char *changedungeon_event_name;
	const char *changemap_event_name;
	const char *exploreregion_event_name;
	const char *exploredungeon_event_name;
	const char *kill_mob_party_event_name;
