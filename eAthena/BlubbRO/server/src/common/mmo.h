...
#define MAX_ACHIEVE_PARAMS 40
#define MAX_ACHIEVE_ROWS 10
...
struct mmo_charstatus {
	...
	bool dungeon[MAX_DUNGEON], region[MAX_REGION];
	struct s_achieveData {
		int AchieveID;
		int count[MAX_ACHIEVE_PARAMS];
		bool finished;
		bool update;
	} achieveData[MAX_ACHIEVEMENTS];
};
...
typedef enum GuildPositionRank {
	GP_NONE = 0,
	...
	GP_MASTER = GP_VIEW | GP_GET | GP_SET,
