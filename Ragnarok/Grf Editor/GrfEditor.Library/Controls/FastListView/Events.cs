...
namespace GrfEditor.Library.Controls {
	...
	partial class ObjectListView {
		...
		[Category("ObjectListView"),
		Description("This event is triggered when objects are removed by index from the control.")]
		public event EventHandler<ItemsRemovingIndiziesEventArgs> ItemsRemovingIndizies;
	...
	public class ItemsRemovingIndiziesEventArgs : CancellableEventArgs {
		/// <summary>
		/// Create an ItemsRemovingEventArgs
		/// </summary>
		/// <param name="objectsToRemove"></param>
		public ItemsRemovingIndiziesEventArgs(List<int> objectsToRemove) {
			this.ObjectsToRemove = objectsToRemove;
		}
		...
		/// Gets or sets the objects that will be removed
		/// </summary>
		public List<int> ObjectsToRemove;
	}
