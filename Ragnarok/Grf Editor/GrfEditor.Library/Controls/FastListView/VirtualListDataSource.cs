...
namespace GrfEditor.Library.Controls {
	...
	public interface IVirtualListDataSource {
		...
		void RemoveIndizies(System.Collections.Generic.List<int> indicesToRemove);
	...
	public class AbstractVirtualListDataSource : IVirtualListDataSource, IFilterableDataSource {
		...
		public virtual void RemoveIndizies(System.Collections.Generic.List<int> indicesToRemove) {
		}
