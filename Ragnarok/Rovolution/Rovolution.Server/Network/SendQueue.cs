...
namespace Rovolution.Server.Network {
	...
	public class SendQueue {
		...
		public class PendingData {
			private static Stack<PendingData> mPoolStack = new Stack<PendingData>();
			...
			public int Available {
				get { return ( mBuffer.Length - mLength ); }
			}

			public bool IsFull {
				get { return ( mLength == mBuffer.Length ); }
			}
			...
			public int Write( byte[] buffer, int offset, int length ) {
				...
				System.Buffer.BlockCopy( buffer, offset, mBuffer, mLength, write );
