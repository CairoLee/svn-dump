...
namespace FRO.AccountCreator.Library {
	...
	public class WebInfo {
		public string Useragent = "Mozilla/5.0 (Windows; U; Windows NT 5.1; de; rv:1.9.1.3) Gecko/20090824 Firefox/3.5.3 (.NET CLR 4.0.20506)";
	...
	public class PostRequest {
		...
		public string UrlReferer {
			get { return mUrlReferer; }
			set { mUrlReferer = value; }
		}
		/// <summary>
