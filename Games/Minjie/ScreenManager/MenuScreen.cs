	...
	abstract class MenuScreen : GameScreen {
		...
		public override void Draw( GameTime gameTime ) {
			...
			if( backgroundTexture != null ) {
				spriteBatch.Draw( backgroundTexture, new Rectangle( 0, 0, ScreenManager.GraphicsDevice.Viewport.Width, ScreenManager.GraphicsDevice.Viewport.Height ), new Rectangle( 0, 0, backgroundTexture.Width, backgroundTexture.Height ), Color.White );
			}
