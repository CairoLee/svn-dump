...
namespace PacMan {
	...
	public class PacMan : Microsoft.Xna.Framework.Game {
		...
		protected override void Initialize() {
			...
			mAudioEngine = new AudioEngine("Content/Audio/YEPAudio.xgs");
			...
			Services.AddService(typeof(AudioEngine), mAudioEngine);
			Services.AddService(typeof(SoundBank), mSoundBank);

			mSpriteBatch = new SpriteBatch(GraphicsDevice);
			Services.AddService(typeof(SpriteBatch), mSpriteBatch);
			Services.AddService(typeof(GraphicsDeviceManager), mGraphicsDeviceManager);
			base.Initialize();
		}
