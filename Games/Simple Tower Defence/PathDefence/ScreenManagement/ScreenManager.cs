...
namespace PathDefence.ScreenManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            spriteBatch = ((PathDefenceGame) Game).SpriteBatch;
            font = content.Load<SpriteFont>("GUI/menufont");
            blankTexture = content.Load<Texture2D>("GUI/blank");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            while (screensToUpdate.Count > 0)
            {
                ...
                if (screen.ScreenState == EScreenState.TransitionOn || screen.ScreenState == EScreenState.Active)
                {
