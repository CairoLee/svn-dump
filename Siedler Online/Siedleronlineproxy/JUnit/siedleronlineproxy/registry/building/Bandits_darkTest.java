 ...
 * @author nspecht
 */
public class Bandits_darkTest {
    
    private GenericBuilding _object;
    
    public Bandits_darkTest() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Dunkler Kult Lager (leicht)", this._object.getName());
        assertEquals(Building.BuildingTypes.BANDITS_DARK, this._object.getType());
