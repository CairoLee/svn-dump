 ...
 * @author nspecht
 */
public class TentTraitorsLeaderTest {
    
    private GenericBuilding _object;
    
    public TentTraitorsLeaderTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new TentTraitorsLeader();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Sir Robin's Schloss", this._object.getName());
        assertEquals(Building.BuildingTypes.TENT_TRAITORS_LEADER, this._object.getType());
