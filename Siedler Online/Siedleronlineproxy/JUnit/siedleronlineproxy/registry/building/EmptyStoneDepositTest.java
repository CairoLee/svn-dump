 ...
 * @author nspecht
 */
public class EmptyStoneDepositTest {
    
    private GenericBuilding _object;
    
    public EmptyStoneDepositTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new EmptyStoneDeposit();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Leeres Steinvorkommen", this._object.getName());
        assertEquals(Building.BuildingTypes.MINEDEPLETEDDEPOSITSTONE, this._object.getType());
