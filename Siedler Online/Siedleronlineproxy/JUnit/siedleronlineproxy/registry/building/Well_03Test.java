...
public class Well_03Test {
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Tiefer Brunnen", this._object.getName());
        assertEquals(Building.BuildingTypes.WELL_03, this._object.getType());
