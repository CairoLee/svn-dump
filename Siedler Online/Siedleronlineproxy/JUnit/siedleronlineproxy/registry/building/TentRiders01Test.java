 ...
 * @author nspecht
 */
public class TentRiders01Test {
    
    private GenericBuilding _object;
    
    public TentRiders01Test() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Reitervolk Lager (mittel)", this._object.getName());
        assertEquals(Building.BuildingTypes.TENT_RIDERS_01, this._object.getType());
