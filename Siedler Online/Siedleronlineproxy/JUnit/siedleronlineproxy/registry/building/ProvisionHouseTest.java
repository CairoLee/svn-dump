 ...
 * @author nspecht
 */
public class ProvisionHouseTest {
    
    private GenericBuilding _object;
    
    public ProvisionHouseTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new ProvisionHouse();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Proviantlager", this._object.getName());
        assertEquals(Building.BuildingTypes.PROVISIONHOUSE, this._object.getType());
