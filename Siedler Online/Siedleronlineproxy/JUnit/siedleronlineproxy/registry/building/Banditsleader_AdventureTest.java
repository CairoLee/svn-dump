 ...
 * @author nspecht
 */
public class Banditsleader_AdventureTest {
    
    private GenericBuilding _object;
    
    public Banditsleader_AdventureTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new Banditsleader_Adventure();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Räuberhauptlader (Abenteuer)", this._object.getName());
        assertEquals(Building.BuildingTypes.BANDITSLEADER_ADVENTURE, this._object.getType());
