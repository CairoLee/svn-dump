...
public class FarmfieldTest {
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Getreidefeld", this._object.getName());
        assertEquals(Building.BuildingTypes.FARMFIELD, this._object.getType());
