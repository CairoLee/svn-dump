 ...
 * @author nspecht
 */
public class ToolmakerTest {
    
    private GenericBuilding _object;
    
    public ToolmakerTest() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Werkzeugschmiede", this._object.getName());
        assertEquals(Building.BuildingTypes.TOOLMAKER, this._object.getType());
    ...
    public void testProducts() {
        ...
        assertTrue(this._object.getProducts().containsKey(Products.TOOL));
        assertSame(1 , this._object.getProducts().get(Products.TOOL));
    }
}
