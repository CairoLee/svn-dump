...
public class LogisticsTest {
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Händlergilde", this._object.getName());
        assertEquals(Building.BuildingTypes.LOGISTICS, this._object.getType());
