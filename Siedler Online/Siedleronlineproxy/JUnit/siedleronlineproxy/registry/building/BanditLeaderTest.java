 ...
 * @author nspecht
 */
public class BanditLeaderTest {
    
    private GenericBuilding _object;
    
    public BanditLeaderTest() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Räuberhauptlager", this._object.getName());
        assertEquals(Building.BuildingTypes.BANDITSLEADER, this._object.getType());
