 ...
 * @author nspecht
 */
public class TentNords02Test {
    
    private GenericBuilding _object;
    
    public TentNords02Test() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Nordländer Lager (schwer)", this._object.getName());
        assertEquals(Building.BuildingTypes.TENT_NORDS_02, this._object.getType());
