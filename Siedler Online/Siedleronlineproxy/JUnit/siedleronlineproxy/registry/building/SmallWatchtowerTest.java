 ...
 * @author nspecht
 */
public class SmallWatchtowerTest {
    
    private GenericBuilding _object;
    
    public SmallWatchtowerTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new SmallWatchtower();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Wachturm", this._object.getName());
        assertEquals(Building.BuildingTypes.SMALLWATCHTOWER, this._object.getType());
