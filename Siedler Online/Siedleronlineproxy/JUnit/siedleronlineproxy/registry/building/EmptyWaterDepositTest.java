 ...
 * @author nspecht
 */
public class EmptyWaterDepositTest {
    
    private GenericBuilding _object;
    
    public EmptyWaterDepositTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new EmptyWaterDeposit();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Ausgetrockneter Brunnen", this._object.getName());
        assertEquals(Building.BuildingTypes.MINEDEPLETEDDEPOSITWATER, this._object.getType());
