...
public class ButcherTest {
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Metzgerei", this._object.getName());
        assertEquals(Building.BuildingTypes.BUTCHER, this._object.getType());
    ...
    public void testNeeds() {
        ...
        assertTrue(this._object.getNeeds().containsKey(Products.MEAT));
        assertSame(4 , this._object.getNeeds().get(Products.MEAT));
    }
    
    @Test
    public void testProducts() {
        assertSame(1, this._object.getProducts().size());
        assertTrue(this._object.getProducts().containsKey(Products.SAUSAGE));
        assertSame(1 , this._object.getProducts().get(Products.SAUSAGE));
    }
}
