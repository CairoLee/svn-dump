 ...
 * @author nspecht
 */
public class TentNords00Test {
    
    private GenericBuilding _object;
    
    public TentNords00Test() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Nordländer Lager (leicht)", this._object.getName());
        assertEquals(Building.BuildingTypes.TENT_NORDS_00, this._object.getType());
