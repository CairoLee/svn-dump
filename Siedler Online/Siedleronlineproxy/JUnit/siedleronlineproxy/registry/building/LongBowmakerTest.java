 ...
 * @author nspecht
 */
public class LongBowmakerTest {
    
    private GenericBuilding _object;
    
    public LongBowmakerTest() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Langbogenmacherei", this._object.getName());
        assertEquals(Building.BuildingTypes.LONGBOWMAKER, this._object.getType());
    ...
    public void testNeeds() {
        ...
        assertSame(16 , this._object.getNeeds().get(Products.REALWOOD));
    }
    
    @Test
    public void testProducts() {
        assertSame(1, this._object.getProducts().size());
        assertTrue(this._object.getProducts().containsKey(Products.LONGBOW));
        assertSame(1 , this._object.getProducts().get(Products.LONGBOW));
    }
}
