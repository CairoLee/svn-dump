 ...
 * @author nspecht
 */
public class TentTraitors02Test {
    
    private GenericBuilding _object;
    
    public TentTraitors02Test() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new TentTraitors02();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Verräter Anführerlager", this._object.getName());
        assertEquals(Building.BuildingTypes.TENT_TRAITORS_02, this._object.getType());
