 ...
 * @author nspecht
 */
public class EmptySalpeterDepositTest {
    
    private GenericBuilding _object;
    
    public EmptySalpeterDepositTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new EmptySalpeterDeposit();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Leere Salpetermine", this._object.getName());
        assertEquals(Building.BuildingTypes.MINEDEPLETEDDEPOSITSALPETER, this._object.getType());
