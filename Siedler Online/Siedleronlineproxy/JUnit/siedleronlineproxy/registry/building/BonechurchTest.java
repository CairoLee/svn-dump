 ...
 * @author nspecht
 */
public class BonechurchTest {
    
    private GenericBuilding _object;
    
    public BonechurchTest() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Knochenkirche", this._object.getName());
        assertEquals(Building.BuildingTypes.BONECHURCH, this._object.getType());
