 ...
 * @author nspecht
 */
public class TentRidersLeaderTest {
    
    private GenericBuilding _object;
    
    public TentRidersLeaderTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new TentRidersLeader();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Reitervolk Anführerlager", this._object.getName());
        assertEquals(Building.BuildingTypes.TENT_RIDERS_LEADER, this._object.getType());
