 ...
 * @author nspecht
 */
public class EmptyCoalMineTest {
    
    private GenericBuilding _object;
    
    public EmptyCoalMineTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new EmptyCoalMine();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Leere Kohlemine", this._object.getName());
        assertEquals(Building.BuildingTypes.MINEDEPLETEDDEPOSITCOAL, this._object.getType());
