 ...
 * @author nspecht
 */
public class EvilSaladTest {
    
    private GenericBuilding _object;
    
    public EvilSaladTest() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Waldfalle", this._object.getName());
        assertEquals(Building.BuildingTypes.EVIL_SALAD, this._object.getType());
