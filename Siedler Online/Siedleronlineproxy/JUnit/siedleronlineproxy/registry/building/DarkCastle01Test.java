 ...
 * @author nspecht
 */
public class DarkCastle01Test {
    
    private GenericBuilding _object;
    
    public DarkCastle01Test() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Schwarzes Schloss des Kults", this._object.getName());
        assertEquals(Building.BuildingTypes.DARK_CASTLE_01, this._object.getType());
