 ...
 * @author nspecht
 */
public class TentTraitors00Test {
    
    private GenericBuilding _object;
    
    public TentTraitors00Test() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new TentTraitors00();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Verräter Lager (leicht)", this._object.getName());
        assertEquals(Building.BuildingTypes.TENT_TRAITORS_00, this._object.getType());
