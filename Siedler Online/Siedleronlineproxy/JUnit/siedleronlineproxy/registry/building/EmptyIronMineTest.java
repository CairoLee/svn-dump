 ...
 * @author nspecht
 */
public class EmptyIronMineTest {
    
    private GenericBuilding _object;
    
    public EmptyIronMineTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new EmptyIronMine();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Leere Eisenmine", this._object.getName());
        assertEquals(Building.BuildingTypes.MINEDEPLETEDDEPOSITIRONORE, this._object.getType());
