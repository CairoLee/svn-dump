 ...
 * @author nspecht
 */
public class BanditLvl2Test {
    
    private GenericBuilding _object;
    
    public BanditLvl2Test() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Räuberlager (mittel)", this._object.getName());
        assertEquals(Building.BuildingTypes.BANDITSLVL2, this._object.getType());
