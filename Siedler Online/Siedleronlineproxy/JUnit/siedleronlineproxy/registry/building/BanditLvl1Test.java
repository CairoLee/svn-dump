 ...
 * @author nspecht
 */
public class BanditLvl1Test {
    
    private GenericBuilding _object;
    
    public BanditLvl1Test() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Räuberlager (leicht)", this._object.getName());
        assertEquals(Building.BuildingTypes.BANDITSLVL1, this._object.getType());
