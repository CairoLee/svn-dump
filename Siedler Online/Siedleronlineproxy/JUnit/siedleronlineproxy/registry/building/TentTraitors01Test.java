 ...
 * @author nspecht
 */
public class TentTraitors01Test {
    
    private GenericBuilding _object;
    
    public TentTraitors01Test() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new TentTraitors01();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Verräter Lager (mittel)", this._object.getName());
        assertEquals(Building.BuildingTypes.TENT_TRAITORS_01, this._object.getType());
