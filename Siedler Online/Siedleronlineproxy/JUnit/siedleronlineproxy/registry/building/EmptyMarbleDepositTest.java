 ...
 * @author nspecht
 */
public class EmptyMarbleDepositTest {
    
    private GenericBuilding _object;
    
    public EmptyMarbleDepositTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new EmptyMarbleDeposit();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Leeres Mamorvorkommen", this._object.getName());
        assertEquals(Building.BuildingTypes.MINEDEPLETEDDEPOSITMARBLE, this._object.getType());
