 ...
 * @author nspecht
 */
public class WitchTowerTest {
    
    private GenericBuilding _object;
    
    public WitchTowerTest() {
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Hexenturm", this._object.getName());
        assertEquals(Building.BuildingTypes.WITCHTOWER, this._object.getType());
