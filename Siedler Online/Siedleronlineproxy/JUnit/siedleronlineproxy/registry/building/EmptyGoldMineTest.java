 ...
 * @author nspecht
 */
public class EmptyGoldMineTest {
    
    private GenericBuilding _object;
    
    public EmptyGoldMineTest() {
    }
    ...
    @Before
    public void setUp() {
        this._object = new EmptyGoldMine();
    }
    ...
    public void testBuildingProperties() {
        ...
        assertEquals("Leere Goldmine", this._object.getName());
        assertEquals(Building.BuildingTypes.MINEDEPLETEDDEPOSITGOLDORE, this._object.getType());
