        ...
        override protected function core(param1:Array, param2:uint) : Array
        {
            ...
            while (_loc_12 < param1.length)
            {
                ...
                while (_loc_21 < 64)
                {
                    ...
                    _loc_22 = (rrol(_loc_4, 2) ^ rrol(_loc_4, 13) ^ rrol(_loc_4, 22)) + (_loc_4 & _loc_5 ^ _loc_4 & _loc_6 ^ _loc_5 & _loc_6);
                    _loc_23 = _loc_11 + (rrol(_loc_8, 6) ^ rrol(_loc_8, 11) ^ rrol(_loc_8, 25)) + (_loc_8 & _loc_9 ^ _loc_10 & ~_loc_8) + k[_loc_21] + _loc_3[_loc_21];
                    _loc_11 = _loc_10;
                    _loc_10 = _loc_9;
                    _loc_9 = _loc_8;
