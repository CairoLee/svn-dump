package com.hurlant.crypto.hash
{
    ...
    public class SHA1 extends SHABase implements IHash
    {
        ...
        override protected function core(param1:Array, param2:uint) : Array
        {
            ...
            var _loc_3:Array = [];
            var _loc_4:uint = 1732584193;
            var _loc_5:uint = 4023233417;
            var _loc_6:uint = 2562383102;
            var _loc_7:uint = 271733878;
            var _loc_8:uint = 3285377520;
            var _loc_9:uint = 0;
            while (_loc_9 < param1.length)
            {
                ...
                while (_loc_15 < 80)
                {
                    ...
                    _loc_16 = rol(_loc_4, 5) + ft(_loc_15, _loc_5, _loc_6, _loc_7) + _loc_8 + _loc_3[_loc_15] + kt(_loc_15);
                    _loc_8 = _loc_7;
                    _loc_7 = _loc_6;
