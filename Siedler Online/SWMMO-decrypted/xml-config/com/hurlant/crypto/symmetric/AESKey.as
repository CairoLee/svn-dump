package com.hurlant.crypto.symmetric
{
    ...
    public class AESKey extends Object implements ISymmetricKey
    {
        ...
        public function decrypt(param1:ByteArray, param2:uint = 0) : void
        {
            var _loc_3:uint = 0;
            state.position = 0;
            state.writeBytes(param1, param2, Nb * 4);
        ...
        protected function invMixSubColumns() : void
        {
            ...
            while (_loc_1 < 4 * Nb)
            {
                ...
                state[_loc_1] = InvSbox[tmp[_loc_1]];
                _loc_1 = _loc_1 + 1;
            }
            return;
        }// end function
        ...
        public function dispose() : void
        {
            ...
            while (_loc_1 < key.length)
            {
                ...
                key[_loc_1] = _loc_2.nextByte();
                _loc_1 = _loc_1 + 1;
            }
            Nr = _loc_2.nextByte();
            _loc_1 = 0;
            while (_loc_1 < state.length)
            {
                
                state[_loc_1] = _loc_2.nextByte();
                _loc_1 = _loc_1 + 1;
            }
            _loc_1 = 0;
            while (_loc_1 < tmp.length)
            {
                
                tmp[_loc_1] = _loc_2.nextByte();
                _loc_1 = _loc_1 + 1;
            }
            key.length = 0;
            keyLength = 0;
        ...
        private function expandKey() : void
        {
            ...
            var _loc_5:uint = 0;
            var _loc_6:uint = 0;
            var _loc_7:* = key.length / 4;
            Nr = _loc_7 + 6;
            _loc_6 = _loc_7;
            while (_loc_6 < Nb * (Nr + 1))
            {
                
                _loc_1 = key[4 * _loc_6 - 4];
                _loc_2 = key[4 * _loc_6 - 3];
                _loc_3 = key[4 * _loc_6 - 2];
                _loc_4 = key[4 * _loc_6 - 1];
                if (!(_loc_6 % _loc_7))
                {
                    _loc_5 = _loc_4;
                    _loc_4 = Sbox[_loc_1];
                ...
                key[4 * _loc_6 + 0] = key[4 * _loc_6 - 4 * _loc_7 + 0] ^ _loc_1;
                key[4 * _loc_6 + 1] = key[4 * _loc_6 - 4 * _loc_7 + 1] ^ _loc_2;
                key[4 * _loc_6 + 2] = key[4 * _loc_6 - 4 * _loc_7 + 2] ^ _loc_3;
                key[4 * _loc_6 + 3] = key[4 * _loc_6 - 4 * _loc_7 + 3] ^ _loc_4;
                _loc_6 = _loc_6 + 1;
            }
            return;
        }// end function
        ...
        protected function addRoundKey(param1:ByteArray, param2:uint) : void
        {
            ...
            while (_loc_3 < 16)
            {
                ...
                state[_loc_3] = state[_loc_3] ^ param1[_loc_3 + param2];
                _loc_3 = _loc_3 + 1;
            }
            return;
        }// end function
        ...
        private static function staticInit() : void
        {
            ...
            while (_loc_1 < 256)
            {
                ...
                Sbox[_loc_1] = _Sbox[_loc_1];
                InvSbox[_loc_1] = _InvSbox[_loc_1];
                Xtime2Sbox[_loc_1] = _Xtime2Sbox[_loc_1];
                Xtime3Sbox[_loc_1] = _Xtime3Sbox[_loc_1];
                Xtime2[_loc_1] = _Xtime2[_loc_1];
                Xtime9[_loc_1] = _Xtime9[_loc_1];
                XtimeB[_loc_1] = _XtimeB[_loc_1];
                XtimeD[_loc_1] = _XtimeD[_loc_1];
                XtimeE[_loc_1] = _XtimeE[_loc_1];
                _loc_1 = _loc_1 + 1;
            }
            var _loc_2:uint = 0;
            while (_loc_2 < _Rcon.length)
            {
                
                Rcon[_loc_2] = _Rcon[_loc_2];
                _loc_2 = _loc_2 + 1;
            }
            return;
        }// end function
