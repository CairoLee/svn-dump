package com.hurlant.crypto.rsa
{
    ...
    public class RSAKey extends Object
    {
        ...
        protected function doPrivate2(param1:BigInteger) : BigInteger
        {
            ...
            var _loc_2:* = param1.mod(p).modPow(dmp1, p);
            var _loc_3:* = param1.mod(q).modPow(dmq1, q);
            while (_loc_2.compareTo(_loc_3) < 0)
            {
                
                _loc_2 = _loc_2.add(p);
            }
            var _loc_4:* = _loc_2.subtract(_loc_3).multiply(coeff).mod(p).multiply(q).add(_loc_3);
            return _loc_4;
        }// end function
