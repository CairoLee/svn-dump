package 
{
    ...
    public class _GUI_Components_ToolTips_PopulationOverviewTipWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
    {

        public function _GUI_Components_ToolTips_PopulationOverviewTipWatcherSetupUtil()
        {
            return;
        }// end function
        ...
        public function setup(param1:Object, param2:Function, param3:Array, param4:Array) : void
        {
            ...
            {
                return [null.LABELS, "NextSettler"];
            }// end function
            ...
            {
                return [LOCA_GROUP.LABELS, "PopulationLimit"];
            }// end function
            ...
            {
                return [LOCA_GROUP.LABELS, "AssignedPopulation"];
            }// end function
            ...
            {
                return [LOCA_GROUP.LABELS, "FreePopulation"];
            }// end function
        ...
        {
            PopulationOverviewTip.watcherSetupUtil = new _GUI_Components_ToolTips_PopulationOverviewTipWatcherSetupUtil;
            return;
        }// end function
