package mx.effects
{
    ...
    public class Effect extends EventDispatcher implements IEffect
    {
        ...
        function captureValues(param1:Array, param2:Boolean) : Array
        {
            ...
            {
                param1 = [];
                _loc_3 = targets.length;
                _loc_4 = 0;
                while (_loc_4 < _loc_3)
                {
                    
                    param1.push(new PropertyChanges(targets[_loc_4]));
                    _loc_4++;
                }
            }
            var _loc_5:* = !filterObject ? (relevantProperties) : (mergeArrays(relevantProperties, filterObject.filterProperties));
            if ((!filterObject ? (relevantProperties) : (mergeArrays(relevantProperties, filterObject.filterProperties))) && _loc_5.length > 0)
            {
                ...
                while (_loc_4 < _loc_3)
                {
                    ...
                    _loc_7 = param1[_loc_4].target;
                    _loc_6 = param2 ? (param1[_loc_4].start) : (param1[_loc_4].end);
                    _loc_8 = _loc_5.length;
                    _loc_9 = 0;
                    while (_loc_9 < _loc_8)
                    {
                        
                        _loc_6[_loc_5[_loc_9]] = getValueFromTarget(_loc_7, _loc_5[_loc_9]);
                        _loc_9++;
                    }
                    _loc_4++;
                }
            ...
            if ((!filterObject ? (relevantStyles) : (mergeArrays(relevantStyles, filterObject.filterStyles))) && _loc_10.length > 0)
            {
                ...
                while (_loc_4 < _loc_3)
                {
                    ...
                    while (_loc_9 < _loc_8)
                    {
                        ...
                        _loc_6[_loc_10[_loc_9]] = _loc_7.getStyle(_loc_10[_loc_9]);
                        _loc_9++;
                    }
                    _loc_4++;
                }
        ...
        public function captureMoreStartValues(param1:Array) : void
        {
            ...
            if (param1.length > 0)
            {
                _loc_2 = captureValues(null, true);
