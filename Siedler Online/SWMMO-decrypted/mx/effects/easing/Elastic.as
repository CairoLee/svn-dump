package mx.effects.easing
{
    ...
    public class Elastic extends Object
    {
        ...
        public static function easeIn(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number = 0, param6:Number = 0) : Number
        {
            ...
            param1 = param1 - 1;
            return -param5 * Math.pow(2, 10 * --param1) * Math.sin((param1 * param4 - _loc_7) * (2 * Math.PI) / param6) + param2;
        }// end function
        ...
        public static function easeInOut(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number = 0, param6:Number = 0) : Number
        {
            ...
            {
                param1 = param1 - 1;
                return -0.5 * (param5 * Math.pow(2, 10 * --param1) * Math.sin((param1 * param4 - _loc_7) * (2 * Math.PI) / param6)) + param2;
            }
            param1 = param1 - 1;
            return param5 * Math.pow(2, -10 * --param1) * Math.sin((param1 * param4 - _loc_7) * (2 * Math.PI) / param6) * 0.5 + param3 + param2;
        }// end function
