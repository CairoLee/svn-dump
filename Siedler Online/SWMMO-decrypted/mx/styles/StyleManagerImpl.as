package mx.styles
{
    ...
    public class StyleManagerImpl extends Object implements IStyleManager2
    {
        ...
        {
            var _loc_4:* = param2;
            var _loc_5:* = param2.selectorRefCount + 1;
        ...
        public function loadStyleDeclarations2(param1:String, param2:Boolean = true, param3:ApplicationDomain = null, param4:SecurityDomain = null) : IEventDispatcher
        {
            ...
            {
                var _loc_2:* = null.IStyleModule(event.module.factory.create());
            ...
            {
                null.removeEventListener(TimerEvent.TIMER, timerHandler);
                timer.stop();
...
class StyleModuleInfo extends Object
{
