    ...
    public class TitleBackground extends ProgrammaticSkin
    {
        ...
        override protected function updateDisplayList(param1:Number, param2:Number) : void
        {
            ...
            if (_loc_7)
            {
                ...
                drawRoundRect(0, 0, param1, param2, {tl:_loc_4, tr:_loc_4, bl:0, br:0}, 16777215, _loc_5[0], null, GradientType.LINEAR, null, {x:0, y:1, w:param1, h:(param2 - 1), r:{tl:_loc_4, tr:_loc_4, bl:0, br:0}});
            }
            return;
        }// end function
