package mx.skins.halo
{
    ...
    public class PanelSkin extends HaloBorder
    {
        ...
        override public function get borderMetrics() : EdgeMetrics
        {
            ...
            _loc_6.bottom = _loc_5.bottom + (isNaN(_loc_11) ? (_loc_2 && !isNaN(_loc_9) ? (_loc_9) : (isNaN(_loc_8) ? (_loc_7) : (_loc_8))) : (_loc_11));
        ...
        override function drawBackground(param1:Number, param2:Number) : void
        {
            ...
            if (getStyle("headerColors") == null && getStyle("borderStyle") == "default")
            {
                ...
                drawRoundRect(0, 0, param1, param2, {tl:radius, tr:radius, bl:0, br:0}, 16777215, _loc_4, null, GradientType.LINEAR, null, {x:0, y:1, w:param1, h:(param2 - 1), r:{tl:radius, tr:radius, bl:0, br:0}});
            }
            return;
        }// end function
