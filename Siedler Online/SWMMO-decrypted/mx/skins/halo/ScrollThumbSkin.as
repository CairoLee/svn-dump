package mx.skins.halo
{
    ...
    public class ScrollThumbSkin extends Border
    {
        ...
        override protected function updateDisplayList(param1:Number, param2:Number) : void
        {
            ...
            var _loc_12:* = Math.max((_loc_5 - 1), 0);
            var _loc_13:Object = {tl:0, tr:_loc_12, bl:0, br:_loc_12};
            _loc_12 = Math.max((_loc_12 - 1), 0);
            var _loc_14:Object = {tl:0, tr:_loc_12, bl:0, br:_loc_12};
            var _loc_15:* = parent && parent.parent && parent.parent.rotation != 0;
            if (isNaN(_loc_3))
            {
                _loc_3 = 16777215;
            }
            ...
            switch(name)
            {
                ...
                default:
                {
                    ...
                    {
                        drawRoundRect(1, param2 - _loc_12, param1 - 3, _loc_12 + 4, {tl:0, tr:0, bl:0, br:_loc_12}, [_loc_11.borderColorDrk1, _loc_11.borderColorDrk1], [1, 0], _loc_15 ? (horizontalGradientMatrix(0, param2 - 4, param1 - 3, 8)) : (verticalGradientMatrix(0, param2 - 4, param1 - 3, 8)), GradientType.LINEAR, null, {x:1, y:param2 - _loc_12, w:param1 - 4, h:_loc_12, r:{tl:0, tr:0, bl:0, br:(_loc_12 - 1)}});
                    }
