    ...
    public class HierarchicalViewCursor extends EventDispatcher implements IViewCursor
    {
            ...
            if (event.kind == CollectionEventKind.ADD)
            {
                ...
                while (_loc_2 < _loc_3)
                {
                    ...
                    if (_loc_9)
                    {
                        ...
                        if (_loc_5 == _loc_6)
                        {
                            var _loc_12:* = currentChildIndex + 1;
                            currentChildIndex = _loc_12;
                        }
                        else if (_loc_8[_loc_5] != null)
                        {
                            var _loc_11:* = childIndexStack;
                            var _loc_12:* = _loc_8[_loc_5];
                            var _loc_13:* = childIndexStack[_loc_8[_loc_5]] + 1;
                            _loc_11[_loc_12] = _loc_13;
                        }
                    }
                    _loc_2++;
                }
        ...
        public function moveToLast() : void
        {
            ...
            while (openNodes[itemToUID(_loc_2)] && dataDescriptor.isBranch(_loc_2, model) && dataDescriptor.hasChildren(_loc_2, model))
            {
                ...
                if (childNodes != null && childNodes.length > 0)
                {
                    ...
                    _loc_2 = childNodes[(childNodes.length - 1)];
                    currentChildIndex = childNodes.length - 1;
                    var _loc_5:* = _currentDepth + 1;
                    _currentDepth = _loc_5;
                    continue;
                }
                childNodes = _loc_3;
                break;
        ...
        public function movePrevious() : Boolean
        {
            ...
            if (parentNodes && parentNodes.length > 0)
            {
                if (currentChildIndex == 0)
                {
                    ...
                    var _loc_3:* = _currentDepth - 1;
                    _currentDepth = _loc_3;
        ...
        public function moveNext() : Boolean
        {
            ...
            do
            {
                ...
                if (childNodes != null && childNodes.length > 0 && currentChildIndex >= Math.max((childNodes.length - 1), 0))
                {
        ...
        public function seek(param1:CursorBookmark, param2:int = 0, param3:int = 0) : void
        {
            ...
            {
                _loc_4 = collection.length - 1;
            }
            else
            {
                _loc_4 = int(param1.value);
            }
            _loc_4 = Math.max(Math.min(_loc_4 + param2, collection.length), 0);
