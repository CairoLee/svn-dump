package mx.controls
{
    ...
    public class Button extends UIComponent implements IDataRenderer, IDropInListItemRenderer, IFocusManagerComponent, IListItemRenderer, IFontContextComponent, IButton
    {
        ...
        function layoutContents(param1:Number, param2:Number, param3:Boolean) : void
        {
            ...
            var _loc_23:* = param1;
            var _loc_24:* = param2;
            var _loc_25:* = currentSkin && currentSkin is IBorder && !(currentSkin is IFlexAsset) ? (IBorder(currentSkin).borderMetrics) : (null);
            if (currentSkin && currentSkin is IBorder && !(currentSkin is IFlexAsset) ? (IBorder(currentSkin).borderMetrics) : (null))
            {
        ...
        override protected function measure() : void
        {
            ...
            var _loc_8:* = currentSkin && currentSkin is IBorder && !(currentSkin is IFlexAsset) ? (IBorder(currentSkin).borderMetrics) : (null);
            if (currentSkin && currentSkin is IBorder && !(currentSkin is IFlexAsset) ? (IBorder(currentSkin).borderMetrics) : (null))
            {
        ...
        private function previousVersion_layoutContents(param1:Number, param2:Number, param3:Boolean) : void
        {
            ...
            var _loc_21:* = param3 ? (buttonOffset) : (0);
            var _loc_22:* = getStyle("textAlign");
            var _loc_23:* = currentSkin && currentSkin is IRectangularBorder ? (IRectangularBorder(currentSkin).borderMetrics) : (null);
            var _loc_24:* = param1;
            ...
            if (labelPlacement == ButtonLabelPlacement.LEFT || labelPlacement == ButtonLabelPlacement.RIGHT)
            {
                ...
                else
                {
                    ...
                    _loc_11 = _loc_11 + (Math.max(0, (_loc_25 - _loc_9) / 2 - 1) + _loc_16);
                }
            }
            else
            {
