package mx.collections
{
    ...
    public class XMLListAdapter extends EventDispatcher implements IList, IXMLNotifiable
    {
        ...
        public function removeAll() : void
        {
            ...
            if (length > 0)
            {
                ...
                while (_loc_1 >= 0)
                {
                    ...
                    stopTrackUpdates(source[_loc_1]);
        ...
        {
            var _loc_2:* = _dispatchEvents - 1;
            _dispatchEvents = _loc_2;
            return;
        }// end function
        ...
        public function xmlNotification(param1:Object, param2:String, param3:Object, param4:Object, param5:Object) : void
        {
            ...
            {
                _loc_9 = param3.parent();
                if (_loc_9 != undefined)
                {
                    _loc_10 = _loc_9.parent();
                    if (_loc_10 === param1)
                    {
                        _loc_6 = _loc_9.name().toString();
                        _loc_8 = param4;
                        _loc_7 = param5;
                    }
                }
