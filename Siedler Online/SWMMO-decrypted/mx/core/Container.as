package mx.core
{
    ...
    public class Container extends UIComponent implements IContainer, IDataRenderer, IFocusManagerContainer, IListItemRenderer, IRawChildrenContainer
    {
        ...
        public function get viewMetrics() : EdgeMetrics
        {
            ...
            var _loc_2:* = verticalScrollBar != null && (doingLayout || verticalScrollPolicy == ScrollPolicy.ON);
            var _loc_3:* = horizontalScrollBar != null && (doingLayout || horizontalScrollPolicy == ScrollPolicy.ON);
            if (!_loc_2 && !_loc_3)
            {
                return _loc_1;
            }
        ...
        {
            var _loc_3:* = numChildrenCreated - 1;
            numChildrenCreated = _loc_3;
        ...
        function rawChildren_setChildIndex(param1:DisplayObject, param2:int) : void
        {
            ...
            {
                var _loc_5:* = _firstChildIndex - 1;
                _firstChildIndex = _loc_5;
            }
        ...
        function rawChildren_removeChildAt(param1:int) : DisplayObject
        {
            ...
            {
                var _loc_4:* = _numChildren - 1;
                _numChildren = _loc_4;
            }
            else if (_numChildren == 0 || param1 < _firstChildIndex)
            {
                var _loc_4:* = _firstChildIndex - 1;
                _firstChildIndex = _loc_4;
            }
            invalidateSize();
            invalidateDisplayList();
            dispatchEvent(new Event("childrenChanged"));
        ...
        private function createScrollbarsIfNeeded(param1:Rectangle) : Boolean
        {
            ...
            var _loc_6:* = param1.left < 0 || param1.top < 0;
            var _loc_7:* = viewMetrics;
            if (scaleX != 1)
            {
            ...
            var _loc_10:* = _loc_8 || _loc_9 || _loc_6 || overlay != null || _loc_7.left > 0 || _loc_7.top > 0;
            if (_loc_4 < _loc_2)
            {
                _loc_10 = true;
        ...
        private function hasChildMatchingDescriptor(param1:UIComponentDescriptor) : Boolean
        {
            ...
            if (_loc_2 != null && _loc_2 in document && document[_loc_2] == null)
            {
                return false;
            }
        ...
        function set forceClipping(param1:Boolean) : void
        {
            if (_clipContent)
            {
                if (param1)
                {
                    var _loc_3:* = _forceClippingCount + 1;
                    _forceClippingCount = _loc_3;
                }
                else
                {
                    var _loc_3:* = _forceClippingCount - 1;
        ...
        {
            var _loc_2:* = contentPane && contentPane.scrollRect ? (contentPane.scrollRect) : (null);
            if (_loc_2)
            {
                contentPane.scrollRect = null;
            }
        ...
        function rawChildren_addChild(param1:DisplayObject) : DisplayObject
        {
            if (_numChildren == 0)
            {
                var _loc_3:* = _firstChildIndex + 1;
                _firstChildIndex = _loc_3;
            }
            super.addingChild(param1);
            $addChild(param1);
            super.childAdded(param1);
