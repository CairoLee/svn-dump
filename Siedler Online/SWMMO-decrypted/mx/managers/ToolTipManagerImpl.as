        ...
        function positionTip() : void
        {
            ...
            if (isError)
            {
                ...
                if (_loc_1 + currentToolTip.width > _loc_3)
                {
                    ...
                    {
                        _loc_6 = _loc_3 - _loc_1 - 4;
                        _loc_7 = Object(toolTipClass).maxWidth;
                        Object(toolTipClass).maxWidth = _loc_6;
                    ...
                    {
                        _loc_2 = _loc_5.top - (currentToolTip.height + 2);
                    }
                    else
                    {
                        _loc_2 = _loc_5.bottom + 2;
                        if (!isNaN(_loc_6))
                        {
                            Object(toolTipClass).maxWidth = _loc_6;
                        }
                ...
                if (!isNaN(_loc_7))
                {
                    Object(toolTipClass).maxWidth = _loc_7;
                }
            }
            else
            {
                _loc_8 = getSystemManager(currentTarget);
                _loc_1 = DisplayObject(_loc_8).mouseX + 11;
                _loc_2 = DisplayObject(_loc_8).mouseY + 22;
                _loc_9 = currentToolTip.width;
                if (_loc_1 + _loc_9 > _loc_3)
                {
                    _loc_1 = _loc_3 - _loc_9;
                }
                _loc_10 = currentToolTip.height;
                if (_loc_2 + _loc_10 > _loc_4)
                {
                    _loc_2 = _loc_4 - _loc_10;
                }
                _loc_11 = new Point(_loc_1, _loc_2);
                _loc_11 = DisplayObject(_loc_8).localToGlobal(_loc_11);
                _loc_11 = DisplayObject(sandboxRoot).globalToLocal(_loc_11);
                _loc_1 = _loc_11.x;
                _loc_2 = _loc_11.y;
            }
