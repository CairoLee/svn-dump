package mx.containers
{
    ...
    public class Panel extends Container implements IConstraintLayout, IFontContextComponent
    {
        ...
        override public function createComponentsFromDescriptors(param1:Boolean = true) : void
        {
            ...
            var _loc_2:* = IUIComponent(getChildAt((numChildren - 1)));
        ...
        override protected function layoutChrome(param1:Number, param2:Number) : void
        {
            ...
            if (getHeaderHeight() > 0 && height >= _loc_8)
            {
                ...
                _loc_10.endFill();
                _loc_10.lineStyle(0, 0, 0);
                _loc_10.drawRect(0, 0, _loc_9, param2);
                ...
                titleTextField.move(_loc_11, (_loc_14 - 1));
                ...
                statusTextField.move(_loc_16, (_loc_14 - 1));
        ...
        override public function get viewMetrics() : EdgeMetrics
        {
            ...
            if (FlexVersion.compatibilityVersion < FlexVersion.VERSION_3_0)
            {
                ...
                _loc_1.bottom = _loc_2.bottom + (isNaN(_loc_7) ? (controlBar && !isNaN(_loc_5) ? (_loc_5) : (isNaN(_loc_4) ? (_loc_3) : (_loc_4))) : (_loc_7));
        ...
        override public function styleChanged(param1:String) : void
        {
            ...
            var _loc_2:* = !param1 || param1 == "styleName";
