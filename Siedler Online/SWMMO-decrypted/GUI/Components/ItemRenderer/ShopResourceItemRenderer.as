package GUI.Components.ItemRenderer
{
    ...
    public class ShopResourceItemRenderer extends HBox
    {
        private var _documentDescriptor_:UIComponentDescriptor;
        private var _1229015684amountLabel:Label;
        private var _384713305resourceIcon:Image;

        public function ShopResourceItemRenderer()
        {
            ...
            this.height = 26;
            this.addEventListener("creationComplete", this.___ShopResourceItemRenderer_HBox1_creationComplete);
            this.addEventListener("toolTipCreate", this.___ShopResourceItemRenderer_HBox1_toolTipCreate);
            return;
        }// end function
        ...
        public function ___ShopResourceItemRenderer_HBox1_toolTipCreate(event:ToolTipEvent) : void
        {
            cToolTipUtil.createToolTip(cToolTipUtil.SIMPLE_string, event);
            return;
        }// end function

        public function ___ShopResourceItemRenderer_HBox1_creationComplete(event:FlexEvent) : void
        {
            this.DisplayData();
            return;
        }// end function
