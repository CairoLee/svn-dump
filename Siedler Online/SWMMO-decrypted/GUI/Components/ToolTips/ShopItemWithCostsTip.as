package GUI.Components.ToolTips
{
    ...
    public class ShopItemWithCostsTip extends VBox implements IDataToolTip
    {
        private var _shipItem:cShopItem;
        private var _252650492costsList:HBox;
        private var _91291148_text:String;
        private var _documentDescriptor_:UIComponentDescriptor;
        private var _1115058732headline:Text;

        public function ShopItemWithCostsTip()
        {
        ...
        {
            this._shipItem = param1 as cShopItem;
            return;
        }// end function
        ...
        public function set text(param1:String) : void
        {
            ...
            if (this._shipItem != null)
            {
                for each (_loc_2 in this._shipItem.GetCosts_vector())
                {
