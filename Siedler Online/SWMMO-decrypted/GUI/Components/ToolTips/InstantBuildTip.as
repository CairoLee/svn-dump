package GUI.Components.ToolTips
{
    ...
    public class InstantBuildTip extends VBox implements IDataToolTip
    {
        ...
        public function InstantBuildTip()
        {
        ...
        {
            this._hardCurrencyAmount = param1 as int;
            return;
        }// end function
        ...
        public function set text(param1:String) : void
        {
            ...
            var _loc_2:* = new dResource();
            _loc_2.name_string = defines.HARD_CURRENCY_RESOURCE_NAME_string;
            _loc_2.amount = this._hardCurrencyAmount;
            var _loc_3:* = new TradeResourceItemRenderer();
