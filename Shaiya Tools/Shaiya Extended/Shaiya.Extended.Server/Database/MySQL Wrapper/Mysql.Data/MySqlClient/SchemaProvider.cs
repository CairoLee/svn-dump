namespace Shaiya.Extended.Server.MySql.Data.MySqlClient
{
    ...
    internal class SchemaProvider
    {
        ...
        private static DataTable GetReservedWords()
        {
            ...
            Stream manifestResourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Shaiya.Extended.Server.MySql.Data.MySqlClient.Properties.ReservedWords.txt");
