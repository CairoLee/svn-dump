namespace ShaiyaMonsterMap {
	partial class frmAbout {
		...
		private void InitializeComponent() {
			...
			this.logoPictureBox.Image = global::ShaiyaMonsterMap.Properties.Resources.godlesz_r0xy;
			...
			this.label1.Text = "Shaiya Monster Map";
			// 
			// label2
			// 
			...
			this.label4.Text = "Images && Help © r0xy.";
			// 
			// frmAbout
			// 
