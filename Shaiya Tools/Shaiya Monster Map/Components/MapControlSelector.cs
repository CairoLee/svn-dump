...
namespace ShaiyaMonsterMap.Components {
	...
	public partial class MapControlSelector : UserControl {
		public static bool CanEdit = false;
		public static List<MapControlSelector> Instances = new List<MapControlSelector>();
		...
		public static void SavePointsAll() {
			MapControlSelector.Instances.ForEach(
				new Action<MapControlSelector>(
					delegate( MapControlSelector Map ) {
						if( Map.Factory != null )
