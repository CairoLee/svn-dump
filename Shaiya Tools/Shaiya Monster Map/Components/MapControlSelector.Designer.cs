namespace ShaiyaMonsterMap.Components {
	partial class MapControlSelector {
		/// <summary> 
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager( typeof( MapControlSelector ) );
			...
			this.tableLayoutMobMap.Controls.Add( this.listMobPoints, 1, 2 );
			this.tableLayoutMobMap.Controls.Add( this.panelMobImages, 1, 1 );
			this.tableLayoutMobMap.Controls.Add( this.MonsterMap, 0, 0 );
			this.tableLayoutMobMap.Controls.Add( this.cmbMap, 1, 0 );
			...
			this.tableLayoutMobMap.RowCount = 3;
			this.tableLayoutMobMap.RowStyles.Add( new System.Windows.Forms.RowStyle( System.Windows.Forms.SizeType.Absolute, 26F ) );
			this.tableLayoutMobMap.RowStyles.Add( new System.Windows.Forms.RowStyle( System.Windows.Forms.SizeType.Absolute, 59F ) );
			this.tableLayoutMobMap.RowStyles.Add( new System.Windows.Forms.RowStyle( System.Windows.Forms.SizeType.Absolute, 433F ) );
			...
			this.listMobPoints.Location = new System.Drawing.Point( 521, 88 );
			this.listMobPoints.Name = "listMobPoints";
			this.listMobPoints.ShowItemToolTips = true;
			this.listMobPoints.Size = new System.Drawing.Size( 294, 427 );
			...
			this.columnLevel.Width = 42;
			// 
			// columnElement
			// 
			this.columnElement.Text = "Element";
			this.columnElement.Width = 59;
			// 
			// columnAnzahl
			// 
			this.columnAnzahl.Text = "Anzahl";
			this.columnAnzahl.Width = 72;
			// 
			// imageListPoints
			// 
			...
			this.panelMobImages.Location = new System.Drawing.Point( 521, 29 );
			...
			this.tableLayoutMobMap.SetRowSpan( this.MonsterMap, 3 );
			...
			this.cmbMap.Location = new System.Drawing.Point( 521, 3 );
			this.cmbMap.Name = "cmbMap";
			this.cmbMap.Size = new System.Drawing.Size( 294, 21 );
		...
		public System.Windows.Forms.ComboBox cmbMap;
