...
namespace Ssc {
	...
	public partial class frmItemBonusWeapon : Form {
		private int mBonusCount = 0;
		private string[] mComboValues;

		public frmItemBonusWeapon( SItem Item, string ItemType ) {
			InitializeComponent();
			...
			cbWeaponType.SelectedIndex = (int)Item.WeaponType;
		...
		private void AddControlRow() {
			...
			Label lbl = new Label();
			lbl.AutoSize = true;
			lbl.Location = new System.Drawing.Point( 12, 50 + ( 37 * yMod ) + 7 + 3 );
			...
			com.Location = new System.Drawing.Point( 64, 50 + ( 37 * yMod ) + 7 );
			...
			num.Location = new System.Drawing.Point( 149, 50 + ( 37 * yMod ) + 7 );
