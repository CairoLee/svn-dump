...
namespace GodLesZ.Library.Pcap.LibPcap {
	...
	public abstract partial class PcapDevice : ICaptureDevice {
		...
		private GodLesZ.Library.Network.Packet.LinkLayers linkType;
		...
		internal virtual IntPtr PcapHandle {
			...
			set {
				...
				if (PcapHandle == IntPtr.Zero) {
					...
					linkType = (GodLesZ.Library.Network.Packet.LinkLayers)LibPcapSafeNativeMethods.pcap_datalink(PcapHandle);
				}
			}
		}
		...
		/// </summary>
		public virtual GodLesZ.Library.Network.Packet.LinkLayers LinkType {
			get {
