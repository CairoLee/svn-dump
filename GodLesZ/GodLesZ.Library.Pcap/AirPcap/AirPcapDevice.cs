...
namespace GodLesZ.Library.Pcap.AirPcap {
	...
	/// AirPcap device
	/// </summary>
	public class AirPcapDevice : GodLesZ.Library.Pcap.WinPcap.WinPcapDevice {
		/// <summary>
		...
		internal AirPcapDevice(WinPcap.WinPcapDevice dev)
			: base(dev.Interface) {
		}
		...
		/// <summary>
		/// Link type in terms of GodLesZ.Library.Network.Packet.LinkLayers
		/// </summary>
		public override GodLesZ.Library.Network.Packet.LinkLayers LinkType {
			get {
				var packetDotNetLinkLayer = GodLesZ.Library.Network.Packet.LinkLayers.Null;

				switch (AirPcapLinkType) {
					case AirPcapLinkTypes._802_11_PLUS_RADIO:
						packetDotNetLinkLayer = GodLesZ.Library.Network.Packet.LinkLayers.Ieee80211_Radio;
						break;
					case AirPcapLinkTypes._802_11:
						packetDotNetLinkLayer = GodLesZ.Library.Network.Packet.LinkLayers.Ieee802;
						break;
					case AirPcapLinkTypes._802_11_PLUS_PPI:
						packetDotNetLinkLayer = GodLesZ.Library.Network.Packet.LinkLayers.PerPacketInformation;
						break;
					default:
