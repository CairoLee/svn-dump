...
namespace GodLesZ.Library.Pcap {
	...
	public interface ICaptureDevice {
		...
		void SendPacket(GodLesZ.Library.Network.Packet.Packet p);
		...
		void SendPacket(GodLesZ.Library.Network.Packet.Packet p, int size);
		...
		/// </summary>
		GodLesZ.Library.Network.Packet.LinkLayers LinkType { get; }
	}
}
