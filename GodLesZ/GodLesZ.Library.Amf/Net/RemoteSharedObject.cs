...
using GodLesZ.Library.Amf.Messaging.Rtmp.SO;
		...
		internal void DispatchSharedObjectMessage(SharedObjectMessage message) {
			...
			foreach (ISharedObjectEvent sharedObjectEvent in message.Events) {
				switch (sharedObjectEvent.Type) {
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_INITIAL_DATA:
						...
						raiseOnConnect = true;
						break;
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_UPDATE_DATA:
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_UPDATE_ATTRIBUTE: {
							...
							if (sharedObjectEvent.Type != GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_UPDATE_ATTRIBUTE)
						...
						break;
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_CLEAR_DATA: {
							ASObject infoObject = new ASObject();
						...
						break;
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_DELETE_ATTRIBUTE:
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_DELETE_DATA: {
						...
						break;
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_STATUS: {
							ASObject infoObject = new ASObject();
						...
						break;
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.CLIENT_SEND_MESSAGE:
					case GodLesZ.Library.Amf.Messaging.Rtmp.SO.SharedObjectEventType.SERVER_SEND_MESSAGE: {
