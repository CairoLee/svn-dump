...
using GodLesZ.Library.Amf.IO.Readers;
...
namespace GodLesZ.Library.Amf.IO {
	...
	public class AMFReader : BinaryReader {
		...
		public static List<List<IAMFReader>> AmfTypeTable {
			get;
			protected set;
		}

		static AMFReader() {
			var amf0Readers = new List<IAMFReader>( new[]
			{
			...
			var amf3Readers = new List<IAMFReader>(new []
			{
			...
			AmfTypeTable = new List<List<IAMFReader>>();
			AmfTypeTable.Add(amf0Readers);
			AmfTypeTable.Add(null);
			AmfTypeTable.Add(null);
			AmfTypeTable.Add(amf3Readers);
		}
