	...
	class EmitHelper {
		...
		*/
		...
		public EmitHelper GenerateThrowUnexpectedAMFException(MemberInfo memberInfo) {
			ConstructorInfo exceptionConstructor = typeof(GodLesZ.Library.Amf.Exceptions.UnexpectedAMF).GetConstructor(AnyVisibilityInstance, null, CallingConventions.HasThis, new Type[] { typeof(string) }, null);
		...
		public EmitHelper GenerateNullValueAccess(MemberInfo memberInfo, Type memberType, Label labelStart) {
			MethodInfo miFluorineConfigurationGetInstance = typeof(GodLesZ.Library.Amf.Configuration.FluorineConfiguration).GetMethod("get_Instance");
			MethodInfo miFluorineConfigurationGetNullableValues = typeof(GodLesZ.Library.Amf.Configuration.FluorineConfiguration).GetMethod("get_NullableValues");
			MethodInfo miTypeGetTypeFromHandle = typeof(Type).GetMethod("GetTypeFromHandle");
			MethodInfo miNullableTypeCollectionGetItem = typeof(GodLesZ.Library.Amf.Configuration.NullableTypeCollection).GetMethod("get_Item", new Type[] { typeof(Type) });
