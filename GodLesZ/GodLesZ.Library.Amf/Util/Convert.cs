...
namespace GodLesZ.Library.Amf.Util {
	...
	public class Convert {
		...
		public static Boolean ToBoolean(Char value) {
			switch (value) {
				case (Char)0:
					return false; // Allow int <=> Char <=> Boolean
				case '0':
					return false;
				case 'n':
					return false;
				...
				case (Char)1:
					return true; // Allow int <=> Char <=> Boolean
				case '1':
					return true;
				case 'y':
					return true;
		...
		public static Decimal ToDecimal(object value) {
			...
			if (value is Boolean)
				return ToDecimal((Boolean)value);
			if (value is Char)
		...
		public static SByte? ToNullableSByte(object value) {
			...
			if (value is Boolean)
				return ToNullableSByte((Boolean)value);
		...
		public static Int16? ToNullableInt16(object value) {
			...
			//
			if (value is Int16)
				return ToNullableInt16((Int16)value);
			if (value is String)
			...
			if (value is Boolean)
				return ToNullableInt16((Boolean)value);
		...
		public static Int32? ToNullableInt32(object value) {
			...
			//
			if (value is Int32)
				return ToNullableInt32((Int32)value);
			if (value is String)
			...
			if (value is Boolean)
				return ToNullableInt32((Boolean)value);
		...
		public static Int64? ToNullableInt64(object value) {
			...
			//
			if (value is Int64)
				return ToNullableInt64((Int64)value);
			if (value is String)
			...
			if (value is Boolean)
				return ToNullableInt64((Boolean)value);
			if (value is DateTime)
		...
		public static Byte? ToNullableByte(object value) {
			...
			if (value is Boolean)
				return ToNullableByte((Boolean)value);
		...
		public static UInt16? ToNullableUInt16(object value) {
			...
			//
			if (value is UInt16)
				return ToNullableUInt16((UInt16)value);
			if (value is String)
			...
			if (value is Boolean)
				return ToNullableUInt16((Boolean)value);
		...
		public static UInt32? ToNullableUInt32(object value) {
			...
			//
			if (value is UInt32)
				return ToNullableUInt32((UInt32)value);
			if (value is String)
			...
			if (value is Boolean)
				return ToNullableUInt32((Boolean)value);
		...
		public static UInt64? ToNullableUInt64(object value) {
			...
			//
			if (value is UInt64)
				return ToNullableUInt64((UInt64)value);
			if (value is String)
			...
			if (value is Boolean)
				return ToNullableUInt64((Boolean)value);
		...
		public static Char? ToNullableChar(object value) {
			...
			if (value is Boolean)
				return ToNullableChar((Boolean)value);
		...
		public static Single? ToNullableSingle(object value) {
			...
			//
			if (value is Single)
				return ToNullableSingle((Single)value);
			if (value is String)
			...
			if (value is Boolean)
				return ToNullableSingle((Boolean)value);
		...
		public static Double? ToNullableDouble(object value) {
			...
			if (value is Boolean)
				return ToNullableDouble((Boolean)value);
			if (value is DateTime)
		...
		public static Boolean? ToNullableBoolean(object value) {
			...
			//
			if (value is Boolean)
				return ToNullableBoolean((Boolean)value);
			if (value is String)
		...
		public static Decimal? ToNullableDecimal(object value) {
			...
			if (value is Boolean)
				return ToNullableDecimal((Boolean)value);
		...
		public static DateTime? ToNullableDateTime(object value) {
			...
			if (value is Int64)
				return ToNullableDateTime((Int64)value);
			if (value is Double)
		...
		public static TimeSpan? ToNullableTimeSpan(object value) {
			...
			if (value is Int64)
				return ToNullableTimeSpan((Int64)value);
			if (value is Double)
		...
		public static SqlByte ToSqlByte(object value) {
			...
			if (value is Boolean)
				return ToSqlByte((Boolean)value);
		...
		public static SqlInt16 ToSqlInt16(object value) {
			...
			if (value is Boolean)
				return ToSqlInt16((Boolean)value);
		...
		public static SqlInt32 ToSqlInt32(object value) {
			...
			if (value is Boolean)
				return ToSqlInt32((Boolean)value);
		...
		public static SqlInt64 ToSqlInt64(object value) {
			...
			if (value is Boolean)
				return ToSqlInt64((Boolean)value);
			if (value is DateTime)
		...
		public static SqlSingle ToSqlSingle(object value) {
			...
			//
			if (value is Single)
				return ToSqlSingle((Single)value);
			if (value is String)
			...
			if (value is Boolean)
				return ToSqlSingle((Boolean)value);
		...
		public static SqlDouble ToSqlDouble(object value) {
			...
			if (value is Boolean)
				return ToSqlDouble((Boolean)value);
			if (value is DateTime)
		...
		public static SqlDecimal ToSqlDecimal(object value) {
			...
			if (value is Boolean)
				return ToSqlDecimal((Boolean)value);
		...
		public static SqlMoney ToSqlMoney(object value) {
			...
			if (value is Boolean)
				return ToSqlMoney((Boolean)value);
		...
		public static SqlBoolean ToSqlBoolean(object value) {
			...
			//
			if (value is Boolean)
				return ToSqlBoolean((Boolean)value);
			if (value is String)
		...
		public static SqlDateTime ToSqlDateTime(object value) {
			...
			if (value is Int64)
				return ToSqlDateTime((Int64)value);
			if (value is Double)
...
#if! SILVERLIGHT
			if (value is SqlString)
				return ToType((SqlString)value);
#if !(NET_1_1)
			if (value is SqlChars)
				return ToType((SqlChars)value);
#endif
			if (value is SqlGuid)
				return ToType((SqlGuid)value);
#endif
		...
		public static Stream ToStream(object value) {
			...
			//
			if (value is Guid)
				return ToStream((Guid)value);
			if (value is Byte[])
				return ToStream((Byte[])value);

			// SqlTypes.
#if! SILVERLIGHT
#if !(NET_1_1)
			if (value is SqlBytes)
				return ToStream((SqlBytes)value);
#endif
			if (value is SqlBinary)
				return ToStream((SqlBinary)value);
			if (value is SqlGuid)
				return ToStream((SqlGuid)value);
#endif
		...
		public static Byte[] ToByteArray(object value) {
			...
			if (value is SByte)
				return ToByteArray((SByte)value);
			if (value is Int16)
				return ToByteArray((Int16)value);
			if (value is Int32)
				return ToByteArray((Int32)value);
			if (value is Int64)
				return ToByteArray((Int64)value);

			if (value is Byte)
				return ToByteArray((Byte)value);
			if (value is UInt16)
				return ToByteArray((UInt16)value);
			if (value is UInt32)
				return ToByteArray((UInt32)value);
			if (value is UInt64)
				return ToByteArray((UInt64)value);

			if (value is Char)
				return ToByteArray((Char)value);
			if (value is Single)
				return ToByteArray((Single)value);
			if (value is Double)
				return ToByteArray((Double)value);
			if (value is Boolean)
				return ToByteArray((Boolean)value);
			if (value is Decimal)
				return ToByteArray((Decimal)value);

			if (value is DateTime)
				return ToByteArray((DateTime)value);
			if (value is TimeSpan)
				return ToByteArray((TimeSpan)value);

			if (value is Stream)
				return ToByteArray((Stream)value);
			if (value is Guid)
				return ToByteArray((Guid)value);

			// SqlTypes.
#if! SILVERLIGHT
			if (value is SqlString)
				return ToByteArray((SqlString)value);

			if (value is SqlByte)
				return ToByteArray((SqlByte)value);
			if (value is SqlInt16)
				return ToByteArray((SqlInt16)value);
			if (value is SqlInt32)
				return ToByteArray((SqlInt32)value);
			if (value is SqlInt64)
				return ToByteArray((SqlInt64)value);

			if (value is SqlSingle)
				return ToByteArray((SqlSingle)value);
			if (value is SqlDouble)
				return ToByteArray((SqlDouble)value);
			if (value is SqlDecimal)
				return ToByteArray((SqlDecimal)value);
			if (value is SqlMoney)
				return ToByteArray((SqlMoney)value);

			if (value is SqlBoolean)
				return ToByteArray((SqlBoolean)value);
			if (value is SqlDateTime)
				return ToByteArray((SqlDateTime)value);

			if (value is SqlBinary)
				return ToByteArray((SqlBinary)value);
#if !(NET_1_1)
			if (value is SqlBytes)
				return ToByteArray((SqlBytes)value);
#endif
			if (value is SqlGuid)
				return ToByteArray((SqlGuid)value);
#endif
			if (value is ByteArray)
				return ToByteArray((ByteArray)value);
		...
		public static Char[] ToCharArray(object value) {
			...
			//
			if (value is String)
				return ToCharArray((String)value);

			// SqlTypes.
#if! SILVERLIGHT
			if (value is SqlString)
				return ToCharArray((SqlString)value);
#if !(NET_1_1)
			if (value is SqlChars)
				return ToCharArray((SqlChars)value);
#endif
#endif
		...
		public static XmlReader ToXmlReader(object value) {
			...
			//
			if (value is String)
				return ToXmlReader((String)value);

			// SqlTypes.
			//
			if (value is SqlString)
				return ToXmlReader((SqlString)value);
#if !(NET_1_1)
			if (value is SqlXml)
				return ToXmlReader((SqlXml)value);
			if (value is SqlChars)
				return ToXmlReader((SqlChars)value);
#endif
			if (value is SqlBinary)
				return ToXmlReader((SqlBinary)value);

			// Other Types.
			//
			if (value is Stream)
				return ToXmlReader((Stream)value);
			if (value is TextReader)
				return ToXmlReader((TextReader)value);
			if (value is XmlDocument)
				return ToXmlReader((XmlDocument)value);

			if (value is Char[])
				return ToXmlReader((Char[])value);
			if (value is Byte[])
				return ToXmlReader((Byte[])value);
		...
		public static XmlDocument ToXmlDocument(object value) {
			...
			//
			if (value is SqlString)
				return ToXmlDocument((SqlString)value);
#if !(NET_1_1)
			if (value is SqlXml)
				return ToXmlDocument((SqlXml)value);
			if (value is SqlChars)
				return ToXmlDocument((SqlChars)value);
#endif
			if (value is SqlBinary)
				return ToXmlDocument((SqlBinary)value);
			...
			if (value is TextReader)
				return ToXmlDocument((TextReader)value);
			if (value is XmlReader)
				return ToXmlDocument((XmlReader)value);

			if (value is Char[])
				return ToXmlDocument((Char[])value);
			if (value is Byte[])
				return ToXmlDocument((Byte[])value);
#if !NET_1_1 && !NET_2_0
			if (value is System.Xml.Linq.XDocument)
				return ToXmlDocument((System.Xml.Linq.XDocument)value);
			if (value is System.Xml.Linq.XElement)
				return ToXmlDocument((System.Xml.Linq.XElement)value);
#endif
