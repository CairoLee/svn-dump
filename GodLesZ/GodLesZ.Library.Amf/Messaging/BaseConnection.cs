...
namespace GodLesZ.Library.Amf.Messaging {
	...
	public abstract class BaseConnection : AttributeStore, IConnection {
		...
		*/
		...
		public virtual void DispatchEvent(GodLesZ.Library.Amf.Messaging.Api.Event.IEvent evt) {
		}
		...
		public virtual bool HandleEvent(GodLesZ.Library.Amf.Messaging.Api.Event.IEvent evt) {
		...
		/// </summary>
		/// <param name="evt">Event.</param>
		public virtual void NotifyEvent(GodLesZ.Library.Amf.Messaging.Api.Event.IEvent evt) {
		}
