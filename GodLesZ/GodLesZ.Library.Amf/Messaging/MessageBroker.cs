...
namespace GodLesZ.Library.Amf.Messaging {
	...
	public class MessageBroker {
		...
		/// </remarks>
		public GodLesZ.Library.Amf.Messaging.Api.IGlobalScope GlobalScope { get { return _globalScope; } }

		internal LoginManager LoginManager {
			get { return _loginManager; }
		}

		internal GodLesZ.Library.Amf.Messaging.Api.IClientRegistry ClientRegistry {
		...
		internal GodLesZ.Library.Amf.Messaging.Api.IClient GetClient(string id) {
