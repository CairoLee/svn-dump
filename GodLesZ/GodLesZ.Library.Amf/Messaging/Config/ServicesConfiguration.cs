...
namespace GodLesZ.Library.Amf.Messaging.Config {
	/// <summary>
	...
	public sealed class ServiceDefinition {
		...
		static AdapterDefinition DefaultRemotingAdapterDefinition = new AdapterDefinition("dotnet", typeof(GodLesZ.Library.Amf.Remoting.RemotingAdapter).FullName, true);
	...
	public sealed class DestinationDefinition {
		...
		/// This member supports the infrastructure and is not intended to be used directly from your code.
		/// </summary>
		public const string FluorineServiceBrowserDestination = "GodLesZ.Library.Amf.ServiceBrowser.FluorineServiceBrowser";
		/// <summary>
		/// This member supports the infrastructure and is not intended to be used directly from your code.
		/// </summary>
		public const string FluorineManagementDestination = "GodLesZ.Library.Amf.ServiceBrowser.ManagementService";
		/// <summary>
		/// This member supports the infrastructure and is not intended to be used directly from your code.
		/// </summary>
		public const string FluorineCodeGeneratorDestination = "GodLesZ.Library.Amf.ServiceBrowser.CodeGeneratorService";
		/// <summary>
		/// This member supports the infrastructure and is not intended to be used directly from your code.
		/// </summary>
		public const string FluorineSqlServiceDestination = "GodLesZ.Library.Amf.ServiceBrowser.SqlService";
	...
	public sealed class LoginCommand {
		/// <summary>
		/// GodLesZ.Library.Amf login command.
		/// </summary>
