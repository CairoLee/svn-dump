...
namespace GodLesZ.Library.Amf.Configuration {
	...
	public enum RemotingServiceAttributeConstraint {
		...
		Browse = 1,
		/// <summary>
		/// Only classes marked [GodLesZ.Library.Amf.RemotingServiceAttribute] are accessible to clients.
		/// </summary>
#if !SILVERLIGHT
		[XmlEnum(Name = "access")]
#endif
	...
	public sealed class FluorineConfiguration {
...
#if (NET_1_1)
							_fluorineSettings = ConfigurationSettings.GetConfig("GodLesZ.Library.Amf/settings") as FluorineSettings;
#else
#if SILVERLIGHT
							_fluorineSettings = new FluorineSettings();
#else
							_fluorineSettings = ConfigurationManager.GetSection("GodLesZ.Library.Amf/settings") as FluorineSettings;
#endif
#endif
		...
		public string WsdlProxyNamespace {
			get {
				...
				return "GodLesZ.Library.Amf.Proxy";
			}
		}
		/// <summary>
