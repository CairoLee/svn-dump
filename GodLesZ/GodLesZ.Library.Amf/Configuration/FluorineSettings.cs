...
#if !FXCLIENT
using GodLesZ.Library.Amf.HttpCompress;
#endif
#if !(NET_1_1)
...
namespace GodLesZ.Library.Amf.Configuration {
...
#if !FXCLIENT
			_wsdlProxyNamespace = "GodLesZ.Library.Amf.Proxy";
...
#endif
 {
		...
		public ClassMappingCollection() {
			Add(typeof(GodLesZ.Library.Amf.AMF3.ArrayCollection).FullName, "flex.messaging.io.ArrayCollection");
			Add(typeof(GodLesZ.Library.Amf.AMF3.ByteArray).FullName, "flex.messaging.io.ByteArray");
			Add(typeof(GodLesZ.Library.Amf.AMF3.ObjectProxy).FullName, "flex.messaging.io.ObjectProxy");

			Add(typeof(GodLesZ.Library.Amf.Messaging.Messages.CommandMessage).FullName, "flex.messaging.messages.CommandMessage");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Messages.RemotingMessage).FullName, "flex.messaging.messages.RemotingMessage");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Messages.AsyncMessage).FullName, "flex.messaging.messages.AsyncMessage");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Messages.AcknowledgeMessage).FullName, "flex.messaging.messages.AcknowledgeMessage");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Messages.ErrorMessage).FullName, "flex.messaging.messages.ErrorMessage");
			//Add(typeof(GodLesZ.Library.Amf.Messaging.Messages.RPCMessage).FullName, "flex.messaging.messages.RPCMessage");			

#if !FXCLIENT
			Add(typeof(GodLesZ.Library.Amf.Data.Messages.DataMessage).FullName, "flex.data.messages.DataMessage");
			Add(typeof(GodLesZ.Library.Amf.Data.Messages.PagedMessage).FullName, "flex.data.messages.PagedMessage");
			Add(typeof(GodLesZ.Library.Amf.Data.Messages.UpdateCollectionMessage).FullName, "flex.data.messages.UpdateCollectionMessage");
			Add(typeof(GodLesZ.Library.Amf.Data.Messages.SequencedMessage).FullName, "flex.data.messages.SequencedMessage");
			Add(typeof(GodLesZ.Library.Amf.Data.Messages.DataErrorMessage).FullName, "flex.data.messages.DataErrorMessage");
			Add(typeof(GodLesZ.Library.Amf.Data.UpdateCollectionRange).FullName, "flex.data.UpdateCollectionRange");

			Add(typeof(GodLesZ.Library.Amf.Messaging.Services.RemotingService).FullName, "flex.messaging.services.RemotingService");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Services.MessageService).FullName, "flex.messaging.services.MessageService");
			Add(typeof(GodLesZ.Library.Amf.Data.DataService).FullName, "flex.data.DataService");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Endpoints.RtmpEndpoint).FullName, "flex.messaging.endpoints.RTMPEndpoint");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Endpoints.AMFEndpoint).FullName, "flex.messaging.endpoints.AMFEndpoint");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Endpoints.StreamingAmfEndpoint).FullName, "flex.messaging.endpoints.StreamingAMFEndpoint");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Endpoints.SecureAmfEndpoint).FullName, "flex.messaging.endpoints.SecureAMFEndpoint");
			Add(typeof(GodLesZ.Library.Amf.Messaging.Endpoints.SecureRtmpEndpoint).FullName, "flex.messaging.endpoints.SecureRTMPEndpoint");
			Add(typeof(GodLesZ.Library.Amf.DotNetAdapter).FullName, "flex.messaging.services.remoting.adapters.JavaAdapter");
#endif
		}
		/// <summary>
		/// This member supports the infrastructure and is not intended to be used directly from your code.
...
#endif
 {
	...
	public class StreamableFileFactorySettings {
		...
		public StreamableFileFactorySettings() {
			_type = typeof(GodLesZ.Library.Amf.Messaging.Rtmp.IO.StreamableFileFactory).FullName;
		}
	...
	public class BWControlServiceSettings {
		...
		public BWControlServiceSettings() {
			_type = typeof(GodLesZ.Library.Amf.Messaging.Rtmp.Stream.DummyBWControlService).FullName;
			_interval = 100;
	...
	public class SchedulingServiceSettings {
		...
		public SchedulingServiceSettings() {
			_type = typeof(GodLesZ.Library.Amf.Scheduling.SchedulingService).FullName;
		}
		/// <summary>
		/// This member supports the infrastructure and is not intended to be used directly from your code.
		/// </summary>
...
#endif
 {
	...
	public sealed class RuntimeSettings {
		...
		public RuntimeSettings() {
			_asyncHandler = false;
			_minWorkerThreads = GodLesZ.Library.Amf.Threading.ThreadPoolEx.DefaultMinWorkerThreads;
			_maxWorkerThreads = GodLesZ.Library.Amf.Threading.ThreadPoolEx.DefaultMaxWorkerThreads;
		}
		/// <summary>
		/// This member supports the infrastructure and is not intended to be used directly from your code.
		/// </summary>
