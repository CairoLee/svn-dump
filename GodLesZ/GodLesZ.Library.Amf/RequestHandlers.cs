...
namespace GodLesZ.Library.Amf {
	/// <summary>
	/// This API supports the infrastructure and is not intended to be used directly from the code.
	...
	/// <summary>
	/// This API supports the GodLesZ.Library.Amf infrastructure and is not intended to be used directly from your code.
