...
namespace GodLesZ.Library.Amf.Collections {
	...
	public class Set : SetBase {
		...
		/// </summary>
		public Set(System.Collections.IComparer comparer)
			: base(comparer, false) {
		}
		...
		/// </summary>
		public Set(System.Collections.IComparer comparer, System.Collections.ICollection collection)
			: this(comparer) {
			foreach (object obj in collection) {
				Add(obj);
			}
