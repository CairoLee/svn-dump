namespace DockSample {
	partial class DummyOutputWindow {
		...
		private void InitializeComponent() {
			...
			this.DockAreas = ( (FinalSoftware.Docking.DockAreas)( ( ( ( ( FinalSoftware.Docking.DockAreas.Float | FinalSoftware.Docking.DockAreas.DockLeft )
						| FinalSoftware.Docking.DockAreas.DockRight )
			...
			this.ShowHint = FinalSoftware.Docking.DockState.DockBottomAutoHide;
			this.TabText = "Output";
			this.Text = "Output";
