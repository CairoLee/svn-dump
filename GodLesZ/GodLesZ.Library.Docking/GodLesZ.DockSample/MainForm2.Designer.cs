namespace DockSample {
	partial class MainForm2 {
		...
		private void InitializeComponent() {
			...
			this.dockPanel = new FinalSoftware.Docking.DockPanel();
			...
			this.dockPanel.DocumentStyle = FinalSoftware.Docking.DocumentStyle.DockingWindow;
		...
		private FinalSoftware.Docking.DockPanel dockPanel;
