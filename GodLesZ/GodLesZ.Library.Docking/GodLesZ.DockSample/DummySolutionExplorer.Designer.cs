namespace DockSample {
	partial class DummySolutionExplorer {
		...
		private void InitializeComponent() {
			...
			System.Windows.Forms.TreeNode treeNode7 = new System.Windows.Forms.TreeNode( "FinalSoftware.Docking", 6, 6 );
			...
			System.Windows.Forms.TreeNode treeNode63 = new System.Windows.Forms.TreeNode( "FinalSoftware.Docking", 3, 3, new System.Windows.Forms.TreeNode[] {
            treeNode35,
            treeNode44,
            treeNode49,
            treeNode50,
			...
			treeNode7.Text = "FinalSoftware.Docking";
			...
			treeNode63.Text = "FinalSoftware.Docking";
			...
			this.DockAreas = ( (FinalSoftware.Docking.DockAreas)( ( ( ( FinalSoftware.Docking.DockAreas.DockLeft | FinalSoftware.Docking.DockAreas.DockRight )
						| FinalSoftware.Docking.DockAreas.DockTop )
						| FinalSoftware.Docking.DockAreas.DockBottom ) ) );
			this.HideOnClose = true;
			this.Icon = ( (System.Drawing.Icon)( resources.GetObject( "$this.Icon" ) ) );
			this.Name = "DummySolutionExplorer";
			this.Padding = new System.Windows.Forms.Padding( 0, 24, 0, 1 );
			this.ShowHint = FinalSoftware.Docking.DockState.DockRight;
