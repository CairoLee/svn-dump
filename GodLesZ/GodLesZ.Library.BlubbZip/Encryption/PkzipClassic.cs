...
namespace GodLesZ.Library.BlubbZip.Encryption {
	/// <summary>
	/// PkblubbClassic embodies the classic or original encryption facilities used in Pkblubb archives.
	/// While it has been superceded by more recent and more powerful algorithms, its still in use and 
	/// is viable for preventing casual snooping
	/// </summary>
	public abstract class PkblubbClassic : SymmetricAlgorithm {
		/// <summary>
	...
	/// <summary>
	/// PkblubbClassicCryptoBase provides the low level facilities for encryption
	/// and decryption using the PkblubbClassic algorithm.
	/// </summary>
	class PkblubbClassicCryptoBase {
		/// <summary>
	...
	/// <summary>
	/// PkblubbClassic CryptoTransform for encryption.
	/// </summary>
	class PkblubbClassicEncryptCryptoTransform : PkblubbClassicCryptoBase, ICryptoTransform {
		/// <summary>
		/// Initialise a new instance of <see cref="PkblubbClassicEncryptCryptoTransform"></see>
		/// </summary>
		/// <param name="keyBlock">The key block to use.</param>
		internal PkblubbClassicEncryptCryptoTransform( byte[] keyBlock ) {
			SetKeys( keyBlock );
		}
	...
	/// <summary>
	/// PkblubbClassic CryptoTransform for decryption.
	/// </summary>
	class PkblubbClassicDecryptCryptoTransform : PkblubbClassicCryptoBase, ICryptoTransform {
		/// <summary>
		/// Initialise a new instance of <see cref="PkblubbClassicDecryptCryptoTransform"></see>.
		/// </summary>
		/// <param name="keyBlock">The key block to decrypt with.</param>
		internal PkblubbClassicDecryptCryptoTransform( byte[] keyBlock ) {
			SetKeys( keyBlock );
		}
	...
	/// <summary>
	/// Defines a wrapper object to access the Pkblubb algorithm. 
	/// This class cannot be inherited.
	/// </summary>
	public sealed class PkblubbClassicManaged : PkblubbClassic {
		/// <summary>
		...
		/// <returns>Returns a new PkblubbClassic encryptor</returns>
		public override ICryptoTransform CreateEncryptor(
			byte[] rgbKey,
			byte[] rgbIV ) {
			key_ = rgbKey;
			return new PkblubbClassicEncryptCryptoTransform( Key );
		}
		...
		public override ICryptoTransform CreateDecryptor(
			...
			byte[] rgbIV ) {
			key_ = rgbKey;
			return new PkblubbClassicDecryptCryptoTransform( Key );
		}
