...
namespace GodLesZ.Library.BlubbZip.Blubb.Compression.Streams {
	...
	public class DeflaterOutputStream : Stream {
		...
		public virtual void Finish() {
			...
			if( !deflater_.IsFinished ) {
				throw new BlubbZipBaseException( "Can't deflate all input?" );
			}
		...
		protected void InitializePassword( string password ) {
			PkblubbClassicManaged pkManaged = new PkblubbClassicManaged();
...
#endif
 {
			...
			if( !deflater_.IsNeedingInput ) {
				throw new BlubbZipBaseException( "DeflaterOutputStream can't deflate all input?" );
			}
		}
		#endregion
