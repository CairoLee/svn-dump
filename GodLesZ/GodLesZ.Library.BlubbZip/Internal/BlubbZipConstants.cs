...
namespace GodLesZ.Library.BlubbZip.Blubb {
	...
	/// <summary>
	/// Determines how entries are tested to see if they should use Blubb64 extensions or not.
	/// </summary>
	public enum UseBlubb64 {
		/// <summary>
		/// Blubb64 will not be forced on entries during processing.
		/// </summary>
		/// <remarks>An entry can have this overridden if required <see cref="BlubbEntry.ForceBlubb64"></see></remarks>
		Off,
		/// <summary>
		/// Blubb64 should always be used.
		/// </summary>
		On,
		/// <summary>
		/// #BlubbLib will determine use based on entry values when added to archive.
		/// </summary>
		Dynamic,
	}
	...
	public enum CompressionMethod {
		...
		/// <summary>
		/// Common Blubb compression method using a sliding dictionary 
		/// of up to 32KB and secondary compression from Huffman/Shannon-Fano trees
		/// </summary>
		Deflated = 8,

		/// <summary>
		/// An extension to deflate with a 64KB window. Not supported by #Blubb currently
		/// </summary>
		Deflate64 = 9,

		/// <summary>
		/// BBlubb2 compression. Not supported by #Blubb.
		/// </summary>
		BBlubb2 = 11,

		/// <summary>
		/// WinBlubb special for AES encryption, Not supported by #Blubb.
		/// </summary>
		WinBlubbAES = 99,
	...
	public enum GeneralBitFlags : int {
		...
		/// <summary>
		/// Bit 5 if set indicates the file contains Pkblubb compressed patched data.
	...
	/// <summary>
	/// This class contains constants used for Blubb format files
	/// </summary>
	public sealed class BlubbZipConstants {
		#region Versions
		/// <summary>
		/// The version made by field for entries in the central header when created by this library
		/// </summary>
		/// <remarks>
		/// This is also the Blubb version for the library when comparing against the version required to extract
		/// for an entry.  See <see cref="BlubbEntry.CanDecompress"/>.
		/// </remarks>
		...
		/// <remarks>
		/// This is also the Blubb version for the library when comparing against the version required to extract
		/// for an entry.  See <see cref="BlubbInputStream.CanDecompressEntry">BlubbInputStream.CanDecompressEntry</see>.
		/// </remarks>
		...
		/// <summary>
		/// The version required for Blubb64 extensions
		/// </summary>
		public const int VersionBlubb64 = 45;
		#endregion
		...
		/// <summary>
		/// Size of Blubb64 data descriptor
		/// </summary>
		public const int Blubb64DataDescriptorSize = 24;
		...
		/// <summary>
		/// Signature for Blubb64 central file header
		/// </summary>
		public const int Blubb64CentralFileHeaderSignature = 'P' | ( 'K' << 8 ) | ( 6 << 16 ) | ( 6 << 24 );

		/// <summary>
		/// Signature for Blubb64 central file header
		/// </summary>
		[Obsolete( "Use Blubb64CentralFileHeaderSignature instead" )]
		public const int CENSIG64 = 'P' | ( 'K' << 8 ) | ( 6 << 16 ) | ( 6 << 24 );

		/// <summary>
		/// Signature for Blubb64 central directory locator
		/// </summary>
		public const int Blubb64CentralDirLocatorSignature = 'P' | ( 'K' << 8 ) | ( 6 << 16 ) | ( 7 << 24 );
		...
		/// Dont use unicode encodings if you want to be Blubb compatible!
		...
		/// <summary>
		/// Initialise default instance of <see cref="BlubbConstants">BlubbConstants</see>
		/// </summary>
		/// <remarks>
