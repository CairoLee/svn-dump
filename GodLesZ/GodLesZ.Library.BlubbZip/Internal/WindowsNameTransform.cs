...
namespace GodLesZ.Library.BlubbZip.Blubb {
	/// <summary>
	/// WindowsNameTransform transforms BlubbFile names to windows compatible ones.
	/// </summary>
	public class WindowsNameTransform : INameTransform {
		...
		/// <summary>
		/// Transform a Blubb directory name to a windows directory name.
		/// </summary>
		...
		/// <summary>
		/// Transform a Blubb format file name to a windows style one.
		/// </summary>
		...
		/// <summary>
		/// Test a name to see if it is a valid name for a windows filename as extracted from a Blubb archive.
		/// </summary>
