...
namespace GodLesZ.Library.BlubbZip.Blubb {
	/// <summary>
	/// BlubbNameTransform transforms names as per the Blubb file naming convention.
	/// </summary>
	/// <remarks>The use of absolute names is supported although its use is not valid 
	/// according to Blubb naming conventions, and should not be used if maximum compatability is desired.</remarks>
	public class BlubbZipNameTransform : INameTransform {
		string trimPrefix_;
		...
		/// <summary>
		/// Initialize a new instance of <see cref="BlubbNameTransform"></see>
		/// </summary>
		public BlubbZipNameTransform() {
		}
		...
		public BlubbZipNameTransform( string trimPrefix ) {
		...
		/// <summary>
		/// Transform a windows directory name according to the Blubb file naming conventions.
		/// </summary>
		...
		public string TransformDirectory( string name ) {
			...
			if( name.Length > 0 ) {
				...
				throw new BlubbZipException( "Cannot have an empty directory name" );
			}
			return name;
		}

		/// <summary>
		/// Transform a windows file name according to the Blubb file naming conventions.
		/// </summary>
		...
		/// <summary>
		/// Test a name to see if it is a valid name for a blubb entry.
		/// </summary>
		/// <param name="name">The name to test.</param>
		/// <param name="relaxed">If true checking is relaxed about windows file names and absolute paths.</param>
		/// <returns>Returns true if the name is a valid blubb name; false otherwise.</returns>
		/// <remarks>Blubb path names are actually in Unix format, and should only contain relative paths.
		...
		/// <param name="name">The name to test.</param>
		/// <returns>Returns true if the name is a valid blubb name; false otherwise.</returns>
		/// <remarks>Blubb path names are actually in unix format,
