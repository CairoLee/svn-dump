...
#if NETCF_1_0
using Stack = GodLesZ.Library.Logging.Util.ThreadContextStack.Stack;
#endif
...
namespace GodLesZ.Library.Logging {
	...
	public sealed class NDC {
		...
		/// <code lang="C#">
		/// using(GodLesZ.Library.Logging.NDC.Push("NDC_Message"))
		/// {
		...
		public static void SetMaxDepth(int maxDepth) {
			if (maxDepth >= 0) {
				GodLesZ.Library.Logging.Util.ThreadContextStack stack = ThreadContext.Stacks["NDC"];
