...
using IRemoteLoggingSink = GodLesZ.Library.Logging.Appender.RemotingAppender.IRemoteLoggingSink;

namespace GodLesZ.Library.Logging.Plugin {
	/// <summary>
	/// Plugin that listens for events from the <see cref="GodLesZ.Library.Logging.Appender.RemotingAppender"/>
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// a remote <see cref="GodLesZ.Library.Logging.Appender.RemotingAppender"/>.
	/// </para>
	/// <para>
