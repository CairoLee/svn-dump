...
namespace GodLesZ.Library.Logging.Core {
	...
	public class LogImpl : LoggerWrapperImpl, ILog {
		...
		/// <see cref="GodLesZ.Library.Logging.ObjectRenderer.IObjectRenderer"/>. It then 
		...
		/// <summary>
		/// Event handler for the <see cref="GodLesZ.Library.Logging.Repository.ILoggerRepository.ConfigurationChanged"/> event
		/// </summary>
