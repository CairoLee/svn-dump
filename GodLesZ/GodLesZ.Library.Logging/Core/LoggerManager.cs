...
namespace GodLesZ.Library.Logging.Core {
	...
	/// </para>
	/// <para>
	/// This class is used by the wrapper managers (e.g. <see cref="GodLesZ.Library.Logging.LogManager"/>)
	...
	/// the <see cref="RepositorySelector"/> property, or by setting the <c>GodLesZ.Library.Logging.RepositorySelector</c>
	...
	public sealed class LoggerManager {
		...
		/// <summary>
		/// Shuts down the GodLesZ.Library.Logging system.
		/// </summary>
		/// <remarks>
		/// <para>
		...
		/// <see cref="GodLesZ.Library.Logging.Repository.Hierarchy.Hierarchy"/> object.
		/// </para>
		/// <para>
		...
		private static string GetVersionInfo() {
			...
			// Build Up message
			sb.Append("GodLesZ.Library.Logging assembly [").Append(myAssembly.FullName).Append("]. ");
		...
		/// </para>
		/// <para>
		/// When the event is triggered the GodLesZ.Library.Logging system is <see cref="Shutdown()"/>.
		/// </para>
		/// </remarks>
