...
namespace GodLesZ.Library.Logging.Core {
	...
	/// is passed around to the different GodLesZ.Library.Logging components.
	/// </para>
	/// <para>
	/// This class is of concern to those wishing to extend GodLesZ.Library.Logging.
	/// </para>
	/// <para>
...
#endif
 {
		...
		/// <see cref="GodLesZ.Library.Logging.Appender.IAppender.DoAppend"/> method call if this event 
		...
		/// </summary>
		public const string HostNameProperty = "GodLesZ.Library.Logging:HostName";

		/// <summary>
		/// The key into the Properties map for the thread identity value.
		/// </summary>
		public const string IdentityProperty = "GodLesZ.Library.Logging:Identity";

		/// <summary>
		/// The key into the Properties map for the user name value.
		/// </summary>
		public const string UserNameProperty = "GodLesZ.Library.Logging:UserName";
