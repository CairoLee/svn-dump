...
namespace GodLesZ.Library.Logging.Core {
	...
	/// </para>
	/// <para>
	/// An alternative is to use the <c>GodLesZ.Library.Logging.Config.SecurityContextProviderAttribute</c>
	/// This attribute can be applied to an assembly in the same way as the
	/// <c>GodLesZ.Library.Logging.Config.XmlConfiguratorAttribute"</c>. The attribute takes
