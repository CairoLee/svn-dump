...
namespace GodLesZ.Library.Logging.Appender {
	...
	/// See also http://logging.apache.org/GodLesZ.Library.Logging/release/faq.html#trouble-EventLog
	/// </para>
	/// <para>
	...
	/// </code>
	/// <para>
	/// The Level is the standard GodLesZ.Library.Logging logging level and eventLogEntryType can be any value
		...
		override public void ActivateOptions() {
			try {
				...
				ErrorHandler.Error("Caught a SecurityException trying to access the EventLog.  Most likely the event source "
					...
					+ "  See http://logging.apache.org/GodLesZ.Library.Logging/release/faq.html#trouble-EventLog",
					ex);
				Threshold = Level.Off;
			}
		}
