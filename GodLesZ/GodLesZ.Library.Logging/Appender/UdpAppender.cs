...
namespace GodLesZ.Library.Logging.Appender {
	...
	/// <appender name="UdpAppender" type="GodLesZ.Library.Logging.Appender.UdpAppender">
	///     <remoteAddress value="224.0.0.1" />
	///     <remotePort value="8080" />
	///     <layout type="GodLesZ.Library.Logging.Layout.PatternLayout" value="%-5level %logger [%ndc] - %message%newline" />
	/// </appender>
	/// </code>
	/// </example>
	...
	public class UdpAppender : AppenderSkeleton {
		...
		public int RemotePort {
			...
			set {
				if (value < IPEndPoint.MinPort || value > IPEndPoint.MaxPort) {
					throw GodLesZ.Library.Logging.Util.SystemInfo.CreateArgumentOutOfRangeException("value", (object)value,
		...
		public override void ActivateOptions() {
			...
			if (this.RemoteAddress == null) {
				...
				throw GodLesZ.Library.Logging.Util.SystemInfo.CreateArgumentOutOfRangeException("this.RemotePort", (object)this.RemotePort,
					"The RemotePort is less than " +
					IPEndPoint.MinPort.ToString(NumberFormatInfo.InvariantInfo) +
					" or greater than " +
					IPEndPoint.MaxPort.ToString(NumberFormatInfo.InvariantInfo) + ".");
			} else if (this.LocalPort != 0 && (this.LocalPort < IPEndPoint.MinPort || this.LocalPort > IPEndPoint.MaxPort)) {
				throw GodLesZ.Library.Logging.Util.SystemInfo.CreateArgumentOutOfRangeException("this.LocalPort", (object)this.LocalPort,
