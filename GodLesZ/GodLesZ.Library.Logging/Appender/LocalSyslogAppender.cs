...
namespace GodLesZ.Library.Logging.Appender {
	...
	public class LocalSyslogAppender : AppenderSkeleton {
		...
		/// <remarks>
		/// <para>
		/// The GodLesZ.Library.Logging Level maps to a syslog severity using the
		...
		/// <summary>
		/// Translates a GodLesZ.Library.Logging level to a syslog severity.
		/// </summary>
		/// <param name="level">A GodLesZ.Library.Logging level.</param>
