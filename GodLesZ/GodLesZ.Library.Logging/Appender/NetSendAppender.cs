...
namespace GodLesZ.Library.Logging.Appender {
	...
	/// <appender name="NetSendAppender_Operator" type="GodLesZ.Library.Logging.Appender.NetSendAppender">
	///     <server value="LOCAL_PC" />
	///     <recipient value="OPERATOR_PC" />
	///     <layout type="GodLesZ.Library.Logging.Layout.PatternLayout" value="%-5p %c [%x] - %m%n" />
	/// </appender>
	/// </code>
	/// </example>
