...
namespace GodLesZ.Library.Logging.Appender {
	...
	public class TextWriterAppender : AppenderSkeleton {
		...
		/// <summary>
		/// Gets or sets the <see cref="GodLesZ.Library.Logging.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </summary>
		/// <value>
		/// The <see cref="GodLesZ.Library.Logging.Util.QuietTextWriter"/> where logging events are written.
		/// </value>
		/// <remarks>
		/// <para>
		/// This is the <see cref="GodLesZ.Library.Logging.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </para>
		/// </remarks>
