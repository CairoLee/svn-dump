...
namespace GodLesZ.Library.Logging.Appender {
	...
	/// </code>
	/// <para>
	/// The Level is the standard GodLesZ.Library.Logging logging level and ForeColor and BackColor can be any
	...
	public class ColoredConsoleAppender : AppenderSkeleton {
		...
		/// <summary>
		/// This method is called by the <see cref="AppenderSkeleton.DoAppend(GodLesZ.Library.Logging.Core.LoggingEvent)"/> method.
		/// </summary>
