...
namespace GodLesZ.Library.Logging.Repository.Hierarchy {
	...
	/// </para>
	/// <para>
	/// This is one of the central classes in the GodLesZ.Library.Logging implementation. One of the
	/// distinctive features of GodLesZ.Library.Logging are hierarchical loggers and their
	...
	public abstract class Logger : IAppenderAttachable, ILogger {
		...
		virtual protected void CallAppenders(LoggingEvent loggingEvent) {
			...
			if (!m_hierarchy.EmittedNoAppenderWarning && writes == 0) {
				...
				LogLog.Debug(declaringType, "Please initialize the GodLesZ.Library.Logging system properly.");
				try {
		...
		/// </summary>
		private GodLesZ.Library.Logging.Util.AppenderAttachedImpl m_appenderAttachedImpl;
