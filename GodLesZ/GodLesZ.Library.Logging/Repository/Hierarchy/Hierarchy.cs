...
namespace GodLesZ.Library.Logging.Repository.Hierarchy {
	...
	public class Hierarchy : LoggerRepositorySkeleton, IBasicRepositoryConfigurator, IXmlRepositoryConfigurator {
		...
		/// using the <see cref="GodLesZ.Library.Logging.LogManager.GetLogger(string)"/> method.
		/// </para>
		/// <para>
		...
		/// <remarks>
		/// <para>
		/// Returns all the <see cref="GodLesZ.Library.Logging.Appender.IAppender"/> instances that are currently configured.
		...
		/// <summary>
		/// Initialize the GodLesZ.Library.Logging system using the specified appender
		/// </summary>
