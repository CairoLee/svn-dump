...
namespace GodLesZ.Library.Logging.Util.PatternStringConverters {
	...
	/// <see cref="GodLesZ.Library.Logging.Util.PatternConverter.Option"/> property to 
	/// the output.
	/// </para>
	/// </remarks>
	...
	internal class LiteralPatternConverter : PatternConverter {
		...
		/// </para>
		/// <para>
		/// Writes the value of <see cref="GodLesZ.Library.Logging.Util.PatternConverter.Option"/>
