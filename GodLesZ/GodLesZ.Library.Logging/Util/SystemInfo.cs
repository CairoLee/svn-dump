...
namespace GodLesZ.Library.Logging.Util {
	...
	public sealed class SystemInfo {
		...
		static SystemInfo() {
...
#if !NETCF
			// Look for GodLesZ.Library.Logging.NullText in AppSettings
			string nullTextAppSettingsKey = SystemInfo.GetAppSetting("GodLesZ.Library.Logging.NullText");
			...
			// Look for GodLesZ.Library.Logging.NotAvailableText in AppSettings
			string notAvailableTextAppSettingsKey = SystemInfo.GetAppSetting("GodLesZ.Library.Logging.NotAvailableText");
		...
		/// <remarks>
		/// <para>
		/// This is the time at which the GodLesZ.Library.Logging library was loaded into the
		/// AppDomain. Due to reports of a hang in the call to <c>System.Diagnostics.Process.StartTime</c>
		/// this is not the start time for the current process.
		/// </para>
		/// <para>
		/// The GodLesZ.Library.Logging library should be loaded by an application early during its
		...
		/// a value for the <c>GodLesZ.Library.Logging.NullText</c> appSetting in the application's
		/// .config file.
		/// </para>
		/// </remarks>
		...
		/// a value for the <c>GodLesZ.Library.Logging.NotAvailableText</c> appSetting in the application's
		/// .config file.
		/// </para>
		/// </remarks>
