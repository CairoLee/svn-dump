...
namespace GodLesZ.Library.Logging.Util {
	/// <summary>
	/// Implements GodLesZ.Library.Logging's default error handling policy which consists 
	...
	public class OnlyOnceErrorHandler : IErrorHandler {
		...
		/// </summary>
		/// <remarks>
		/// Defaults to <see cref="GodLesZ.Library.Logging.Core.ErrorCode.GenericFailure"/>
		/// </remarks>
