...
namespace GodLesZ.Library.Logging.Util {
	...
	/// </para>
	/// <para>
	/// This class functions similarly to the <see cref="GodLesZ.Library.Logging.Layout.PatternLayout"/>
	/// in that it accepts a pattern and renders it to a string. Unlike the 
	/// <see cref="GodLesZ.Library.Logging.Layout.PatternLayout"/> however the <c>PatternString</c>
	...
	/// </para>
	/// <para>
	/// See the <see cref="GodLesZ.Library.Logging.Layout.PatternLayout"/> for details on the 
