...
namespace GodLesZ.Library.Logging.Util.TypeConverters {
	...
	public sealed class ConverterRegistry {
		...
		static ConverterRegistry() {
			...
			AddConverter(typeof(GodLesZ.Library.Logging.Layout.PatternLayout), typeof(PatternLayoutConverter));
			AddConverter(typeof(GodLesZ.Library.Logging.Util.PatternString), typeof(PatternStringConverter));
