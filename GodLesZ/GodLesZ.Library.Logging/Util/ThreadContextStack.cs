...
namespace GodLesZ.Library.Logging.Util {
	/// <summary>
	/// Implementation of Stack for the <see cref="GodLesZ.Library.Logging.ThreadContext"/>
	/// </summary>
	/// <remarks>
	/// <para>
	/// Implementation of Stack for the <see cref="GodLesZ.Library.Logging.ThreadContext"/>
	...
	public sealed class ThreadContextStack : IFixingRequired {
		...
		/// for example by using the <c>using(GodLesZ.Library.Logging.ThreadContext.Stacks["NDC"].Push("Stack_Message"))</c> 
		/// syntax.
		/// </para>
		/// </remarks>
		public void Clear() {
		...
		/// <code lang="C#">
		/// using(GodLesZ.Library.Logging.ThreadContext.Stacks["NDC"].Push("Stack_Message"))
		/// {
