...
namespace GodLesZ.Library.Logging.Util {
	...
	/// <summary>
	/// Outputs log statements from within the GodLesZ.Library.Logging assembly.
	/// </summary>
	/// <remarks>
	/// <para>
	/// Log4net components cannot make GodLesZ.Library.Logging logging calls. However, it is
	/// sometimes useful for the user to learn about what GodLesZ.Library.Logging is
	/// doing.
	/// </para>
	/// <para>
	/// All GodLesZ.Library.Logging internal debug calls go to the standard output stream
	...
	public sealed class LogLog {
		...
		/// "GodLesZ.Library.Logging:ERROR ", 
		/// "GodLesZ.Library.Logging:WARN "
		/// </remarks>
		...
		/// <remarks>
		/// <para>
		/// The <c>GodLesZ.Library.Logging.Internal.Debug</c> application setting
		/// controls internal debugging. This setting should be set
		/// to <c>true</c> to enable debugging.
		/// </para>
		/// <para>
		/// The <c>GodLesZ.Library.Logging.Internal.Quiet</c> application setting
...
#if !NETCF
			try {
				InternalDebugging = OptionConverter.ToBoolean(SystemInfo.GetAppSetting("GodLesZ.Library.Logging.Internal.Debug"), false);
				QuietMode = OptionConverter.ToBoolean(SystemInfo.GetAppSetting("GodLesZ.Library.Logging.Internal.Quiet"), false);
				EmitInternalMessages = OptionConverter.ToBoolean(SystemInfo.GetAppSetting("GodLesZ.Library.Logging.Internal.Emit"), true);
			} catch (Exception ex) {
		...
		/// <summary>
		/// Gets or sets a value indicating whether GodLesZ.Library.Logging internal logging
		/// is enabled or disabled.
		/// </summary>
		/// <value>
		/// <c>true</c> if GodLesZ.Library.Logging internal logging is enabled, otherwise 
		/// <c>false</c>.
		/// </value>
		/// <remarks>
		/// <para>
		...
		/// <c>GodLesZ.Library.Logging.Internal.Debug</c> in the application configuration
		/// file.
		/// </para>
		/// <para>
		...
		/// <configuration>
		///		<appSettings>
		///			<add key="GodLesZ.Library.Logging.Internal.Debug" value="true" />
		///		</appSettings>
		/// </configuration>
		/// </code>
		/// </example>
		...
		/// <summary>
		/// Gets or sets a value indicating whether GodLesZ.Library.Logging should generate no output
		/// from internal logging, not even for errors. 
		/// </summary>
		/// <value>
		/// <c>true</c> if GodLesZ.Library.Logging should generate no output at all from internal 
		...
		/// <c>GodLesZ.Library.Logging.Internal.Quiet</c> in the application configuration file.
		/// </para>
		/// <para>
		...
		/// <configuration>
		///		<appSettings>
		///			<add key="GodLesZ.Library.Logging.Internal.Quiet" value="true" />
		///		</appSettings>
		/// </configuration>
		/// </code>
		/// </example>
		...
		/// <summary>
		/// Writes GodLesZ.Library.Logging internal debug messages to the 
		...
		///	the string "GodLesZ.Library.Logging: ".
		/// </para>
		/// </remarks>
		...
		/// <summary>
		/// Writes GodLesZ.Library.Logging internal warning messages to the 
		...
		///	the string "GodLesZ.Library.Logging:WARN ".
		/// </para>
		/// </remarks>
		...
		/// <summary>
		/// Writes GodLesZ.Library.Logging internal error messages to the 
		/// standard error stream.
		/// </summary>
		/// <param name="source">The Type that generated this message.</param>
		/// <param name="message">The message to log.</param>
		...
		///	the string "GodLesZ.Library.Logging:ERROR ".
		/// </para>
		/// </remarks>
		...
		private const string PREFIX = "GodLesZ.Library.Logging: ";
		private const string ERR_PREFIX = "GodLesZ.Library.Logging:ERROR ";
		private const string WARN_PREFIX = "GodLesZ.Library.Logging:WARN ";
