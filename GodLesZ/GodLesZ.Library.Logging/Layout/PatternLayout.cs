...
using GodLesZ.Library.Logging.Layout.Pattern;
using GodLesZ.Library.Logging.Util;
using GodLesZ.Library.Logging.Util.PatternStringConverters;
using AppDomainPatternConverter = GodLesZ.Library.Logging.Layout.Pattern.AppDomainPatternConverter;
using DatePatternConverter = GodLesZ.Library.Logging.Layout.Pattern.DatePatternConverter;
using IdentityPatternConverter = GodLesZ.Library.Logging.Layout.Pattern.IdentityPatternConverter;
using PropertyPatternConverter = GodLesZ.Library.Logging.Layout.Pattern.PropertyPatternConverter;
using UserNamePatternConverter = GodLesZ.Library.Logging.Layout.Pattern.UserNamePatternConverter;
using UtcDatePatternConverter = GodLesZ.Library.Logging.Layout.Pattern.UtcDatePatternConverter;
...
namespace GodLesZ.Library.Logging.Layout {
	...
	/// that the GodLesZ.Library.Logging environment was set to use a PatternLayout. Then the
	/// statements
	/// </para>
	/// <code lang="C#">
	...
	/// 			assumed (<see cref="GodLesZ.Library.Logging.DateFormatter.Iso8601DateFormatter"/>).
	/// 			</para>
	/// 			<para>
	...
	/// 			</para>
	/// 			<para>
	/// 			For better results it is recommended to use the GodLesZ.Library.Logging date
	/// 			formatters. These can be specified using one of the strings
	/// 			"ABSOLUTE", "DATE" and "ISO8601" for specifying 
	/// 			<see cref="GodLesZ.Library.Logging.DateFormatter.AbsoluteTimeDateFormatter"/>, 
	/// 			<see cref="GodLesZ.Library.Logging.DateFormatter.DateTimeDateFormatter"/> and respectively 
	/// 			<see cref="GodLesZ.Library.Logging.DateFormatter.Iso8601DateFormatter"/>. For example, 
	...
	/// 			the <c>GodLesZ.Library.Logging:HostName</c> property is set to the name of machine on 
	...
	/// 			</para>
	/// 			<para>
	/// 			For example, for the class name "GodLesZ.Library.Logging.Layout.PatternLayout", the
