...
namespace GodLesZ.Library.Logging.Layout {
	...
	/// GodLesZ.Library.Logging:event elements. It does not output a complete well-formed XML 
	...
	/// &lt;?xml version="1.0" ?&gt;
	/// 
	/// &lt;!DOCTYPE GodLesZ.Library.Logging:events SYSTEM "GodLesZ.Library.Logging-events.dtd" [&lt;!ENTITY data SYSTEM "abc"&gt;]&gt;
	///
	/// &lt;GodLesZ.Library.Logging:events version="1.2" xmlns:GodLesZ.Library.Logging="http://logging.apache.org/GodLesZ.Library.Logging/schemas/GodLesZ.Library.Logging-events-1.2&gt;
	///     &amp;data;
	/// &lt;/GodLesZ.Library.Logging:events&gt;
	/// </code>
	/// <para>
	...
	public class XmlLayout : XmlLayoutBase {
		...
		/// <remarks>
		/// <para>
		/// The default prefix is <b>GodLesZ.Library.Logging</b>. Set this property
