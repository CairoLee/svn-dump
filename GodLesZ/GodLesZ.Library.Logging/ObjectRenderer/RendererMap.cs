...
namespace GodLesZ.Library.Logging.ObjectRenderer {
	/// <summary>
			...
			if (obj == null) {
				...
				if (str != null) {
					...
					try {
						...
						GodLesZ.Library.Logging.Util.LogLog.Error(declaringType, "Exception while rendering object of type [" + obj.GetType().FullName + "]", ex);
						...
						writer.Write("<GodLesZ.Library.Logging.Error>Exception rendering object type [" + objectTypeName + "]");
						if (ex != null) {
						...
						writer.Write("</GodLesZ.Library.Logging.Error>");
					}
				}
			}
		}
