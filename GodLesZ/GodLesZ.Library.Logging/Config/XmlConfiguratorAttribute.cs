...
namespace GodLesZ.Library.Logging.Config {
	...
	/// When using the GodLesZ.Library.Logging assembly level attributes to control the configuration 
	/// of GodLesZ.Library.Logging you must ensure that the first call to any of the 
	/// <see cref="GodLesZ.Library.Logging.Core.LoggerManager"/> methods is made from the assembly with the configuration
	/// attributes. 
	/// </para>
	/// <para>
	/// If you cannot guarantee the order in which GodLesZ.Library.Logging calls will be made from 
