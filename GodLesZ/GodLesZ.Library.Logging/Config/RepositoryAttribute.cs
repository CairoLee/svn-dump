...
namespace GodLesZ.Library.Logging.Config {
	...
	/// specifies the type of the <see cref="GodLesZ.Library.Logging.Repository.ILoggerRepository"/> object 
	...
	public /*sealed*/ class RepositoryAttribute : Attribute {
		...
		/// The type must implement the <see cref="GodLesZ.Library.Logging.Repository.ILoggerRepository"/>
		/// interface.
		/// </para>
		/// <para>
