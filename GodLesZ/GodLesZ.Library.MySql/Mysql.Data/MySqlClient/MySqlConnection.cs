...
namespace GodLesZ.Library.MySql.Data.MySqlClient {
	...
	public sealed class MySqlConnection : DbConnection, ICloneable {
		private GodLesZ.Library.MySql.Data.MySqlClient.UsageAdvisor advisor;
		...
		[Editor("GodLesZ.Library.MySql.Data.MySqlClient.Design.ConnectionStringTypeEditor,MySqlClient.Design", typeof(UITypeEditor)), Description("Information used to connect to a DataSource, such as 'Server=xxx;UserId=yyy;Password=zzz;Database=dbdb'."), Browsable(true), Category("Data")]
		...
		internal GodLesZ.Library.MySql.Data.MySqlClient.ProcedureCache ProcedureCache {
		...
		[Browsable(false)]
		internal GodLesZ.Library.MySql.Data.MySqlClient.UsageAdvisor UsageAdvisor {
