...
namespace GodLesZ.Library.Xna.WindowLibrary.Controls {
	...
	public class Console : Container {
		...
		private ConsoleChannelList channels = new ConsoleChannelList();
		private List<byte> filter = new List<byte>();
		private EConsoleMessageFormats messageFormat = EConsoleMessageFormats.None;
		...
		public virtual ConsoleChannelList Channels {
			get { return channels; }
			set {
		...
		public virtual EConsoleMessageFormats MessageFormat {
