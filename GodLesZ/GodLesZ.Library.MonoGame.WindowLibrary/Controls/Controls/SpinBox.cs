...
namespace GodLesZ.Library.Xna.WindowLibrary.Controls {
	...
	public class SpinBox : TextBox {
		...
		private ESpinBoxMode mode = ESpinBoxMode.List;
		...
		public new virtual ESpinBoxMode Mode {
			get { return mode; }
			set { mode = value; }
		}
		...
		public override void Init() {
			...
			btnUp.Glyph.SizeMode = ESizeMode.Centered;
			...
			btnDown.Glyph.SizeMode = ESizeMode.Centered;
