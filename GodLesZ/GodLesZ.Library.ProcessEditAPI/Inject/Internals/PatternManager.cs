...
namespace GodLesZ.Library.ProcessEditAPI.Inject.Internals {
	...
	public class PatternManager {
		private readonly Dictionary<string, IntPtr> mPatterns = new Dictionary<string, IntPtr>();
		...
		public void LoadFile( string file, ADDR start, ADDR length ) {
			...
			LoadFile( XElement.Load( file ), mWin32.ReadBytes( (IntPtr)start, (int)length ), start );
		}
